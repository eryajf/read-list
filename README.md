...
<!-- juejin:START -->
- 🤗 [员工离职困扰？来看AI如何解决，基于人力资源分析的 ML 模型构建全方案](https://juejin.cn/post/7134531118430158862) | Mon Aug 22 2022 3:04 AM 
    <details><summary>展开描述 ...</summary> 
    本文通过数据科学和AI的方法，分析挖掘人力资源流失问题，构建基于机器学习的解决方案，并通过对AI模型的反向解释，深入理解导致人员流失的主要因素。 
    </details> 

- 🎡 [如何在 SAP BTP 上 手动执行 workflow](https://juejin.cn/post/7134531070971609124) | Mon Aug 22 2022 3:04 AM 
    <details><summary>展开描述 ...</summary> 
    携手创作，共同成长！这是我参与「掘金日新计划 · 8 月更文挑战」的第27天，点击查看活动详情 官网地址： https://developers.sap.com/tutorials/cp-starte 
    </details> 

- 🕯 [总结八年跨端开发经验，浅谈跨端的历史和未来方向,延时任务-基于netty时间轮算法实现,换个姿势，十分钟拿下Java/Kotlin泛型| 酱酱的下午茶第55期](https://juejin.cn/post/7134529866145693710) | Mon Aug 22 2022 3:00 AM 
    <details><summary>展开描述 ...</summary> 
    本期看点：贝塞尔曲线轨迹运动原理与实战，使用Vite重构Vue3项目，剖析 React 渲染模型，延时任务-基于netty时间轮算法实现，换个姿势，十分钟拿下Java/Kotlin泛型 
    </details> 

- 🚀 [iOS小技能：简化版的隐私弹窗](https://juejin.cn/post/7134527572066435108) | Mon Aug 22 2022 2:51 AM 
    <details><summary>展开描述 ...</summary> 
    携手创作，共同成长！这是我参与「掘金日新计划 · 8 月更文挑战」的第27天，点击查看活动详情 引言 本文针对不熟悉iOS代码的读者，如果是有经验的开发请看这篇文章：https://kunnan.bl 
    </details> 

- 💪 [『互联网架构』理解ELK入门](https://juejin.cn/post/7134521506692300830) | Mon Aug 22 2022 2:27 AM 
    <details><summary>展开描述 ...</summary> 
    （一）ELK是什么 出现问题log的重要性 1.日志量太大如何归档、文本搜索太慢怎么办、如何多维度查询。 2.应用太多，面临数十上百台应用时你该怎么办。 3.随意登录服务器查询log对系统的稳定性及安 
    </details> 
<!-- juejin:END -->
### 少数派
