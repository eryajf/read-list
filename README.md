...
- 🚀 [Flutter Hive Box 基本使用和源码分析（数据结构）](https://juejin.cn/post/7119785958106464292) | Wed Jul 13 2022 9:26 AM 
    <details><summary>展开描述 ...</summary> 
    hive box是一个轻量级key-value数据库，其优秀的性能和数据可监听特性，对于大小型项目用来缓存数据非常有用。今天我们来分析其源码，看看其储存的数据格式和流程。 
    </details> 
