...
- 🎡 [程序员成长第十六篇：代码重构](https://juejin.cn/post/7134675585221017631) | Mon Aug 22 2022 12:26 PM 
    <details><summary>展开描述 ...</summary> 
    代码重构重构就是在不改变软件系统外部行为的前提下，改善它的内部结构。重构不是重写，它们的区别你可以理解为，重构是修复代码，大框架不变。重写是扔掉原来的，重新设计框架。 
    </details> 

- 🕯 [Swift基础语法（二十一）常见编程范式认识：函数式编程](https://juejin.cn/post/7134674506160799774) | Mon Aug 22 2022 12:21 PM 
    <details><summary>展开描述 ...</summary> 
    携手创作，共同成长！这是我参与「掘金日新计划 · 8 月更文挑战」的第25天，点击查看活动详情 1. 认识 函数式编程（ Funtional Programming ，简称FP）是一种编程范式，也就是 
    </details> 

- 🚀 [浅谈 Rust 前端应用开发](https://juejin.cn/post/7134670785553104910) | Mon Aug 22 2022 12:07 PM 
    <details><summary>展开描述 ...</summary> 
    传统的前端应用几乎都是使用 JS 作为主要语言来实现，但随着技术的不断演进，近年来愈来越多的非前端开发语言诸如：Rust、Go等也开始进入前端/跨端应用开发领域，并收获了不小的开源社区的关注。因此本次 
    </details> 

- 💪 [夯实基础，常见的数据结构](https://juejin.cn/post/7134670627612393509) | Mon Aug 22 2022 12:07 PM 
    <details><summary>展开描述 ...</summary> 
    携手创作，共同成长！这是我参与「掘金日新计划 · 8 月更文挑战」的第22天，点击查看活动详情 所谓“巧妇难为无米之炊”，再强大的计算机，也要有“米”下锅才可以干活，否则就是一堆破铜烂铁。这个“米”就 
    </details> 
<!-- juejin:END -->
### 少数派
