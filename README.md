...
<!-- juejin:START -->
- 🤗 [东方甄选推独立App自立门户；西湖大学『强化学习数学基础』教材书稿；经典书籍『深入浅出设计模式』Python版代码；前沿论文 | ShowMeAI资讯日报](https://juejin.cn/post/7137172339870924814) | Mon Aug 29 2022 5:54 AM 
    <details><summary>展开描述 ...</summary> 
    ShowMeAI资讯日报 08-29 期，可交互的Jupyter绘图库、Apache Flink机器学习库、文本分类效果的分析工具、Gym强化学习研究环境、对抗可解释AI资源列表、前沿论文… 
    </details> 

- 🎡 [【CSS 教程系列第 9 篇】什么是 CSS 中的子代选择器](https://juejin.cn/post/7137167940251549704) | Mon Aug 29 2022 5:38 AM 
    <details><summary>展开描述 ...</summary> 
    什么是 CSS 中的子代选择器。 与后代选择器不同，子代选择器只选择父级元素的亲一代。在父级元素的后面，加上一个 &gt; 符号（大于号），表示这是亲一代。 
    </details> 

- 🕯 [Element 2 组件源码剖析之Input输入框&lpar;下&rpar;](https://juejin.cn/post/7137159746791931940) | Mon Aug 29 2022 5:06 AM 
    <details><summary>展开描述 ...</summary> 
    输入框组件 `Input` 通过鼠标或键盘输入表单域内容，提供复合型型输入框，带搜索的输入框，还可以进行大小选择。 本文将分析其源码实现，耐心读完，相信会对您有所帮助。 
    </details> 

- 🚀 [Java应用启动优化](https://juejin.cn/post/7137157959393968159) | Mon Aug 29 2022 4:58 AM 
    <details><summary>展开描述 ...</summary> 
    在开发环境下，每次应用启动都需要等待... 影响开发效率，怎么能让自己的应用启动的更快一点，分享下个人的经验？ 
    </details> 

- 💪 [你还有什么问题吗？](https://juejin.cn/post/7137157243292057613) | Mon Aug 29 2022 4:55 AM 
    <details><summary>展开描述 ...</summary> 
    在面试过程中，一般都会有一个固定环节，那就是在临近结束时，面试官会问求职者：你还有什么问题吗？ 其实，这是一个很好的了解公司，了解未来团队的机会，但很多求职者却不知道问什么，或者是问不到点儿上，错过了 
    </details> 
<!-- juejin:END -->
### 少数派
...
<!-- zhihu:START -->
- 🤩 [瞎扯 · 如何正确地吐槽](http://daily.zhihu.com/story/9752265) | Mon Aug 29 2022 12:27 AM
- 🐻 [你被哪些雕塑作品震撼过？](http://daily.zhihu.com/story/9752234) | Mon Aug 29 2022 12:27 AM
- 🌏 [薛定谔的猫在没打开的时候又是生又是死，是否是一种叠加状态？](http://daily.zhihu.com/story/9752243) | Mon Aug 29 2022 12:27 AM
- 🕴 [为什么吃东西时会感觉第一口最好吃？](http://daily.zhihu.com/story/9752247) | Mon Aug 29 2022 12:27 AM
- 🌮 [英雄联盟 TES 战队的 Wayward 水平如何？](http://daily.zhihu.com/story/9752254) | Mon Aug 29 2022 12:27 AM<!-- zhihu:END -->
...
<!-- iui:START -->
- 🌊 [2022 年 8 月每日分享](https://iui.su/160/) | Mon Aug 29 2022 4:31 AM 
    <details><summary>展开描述 ...</summary> 
    可以收藏「不死鸟发布页」dalao.ru ，速记：大佬点入 关于不死鸟每日分享栏目发现一些不错的资源，你有好的发现点击这里快速投稿，如需图文或其它建议可在这里回复反馈。8月29日anon、fli... 
    </details> 
