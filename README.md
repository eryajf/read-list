...
- 🚀 [7 个小技巧助你用 TS 写出干净的 React 代码](https://juejin.cn/post/7122078682750910477) | Tue Jul 19 2022 1:42 PM 
    <details><summary>展开描述 ...</summary> 
    干净的代码&lpar;clean code&rpar;不只是可以正常运行的代码。它指的是组织整齐、易于阅读、易于理解且易于维护的代码。 让我们看一下 React 中干净的代码的一些最佳实践。做好这些，让你在度假 ⛱️ 时 
    </details> 

- 💪 [Unity中文版？脚本也用中文？用中文写了个剧情小游戏，真好玩~](https://juejin.cn/post/7122068504081072141) | Tue Jul 19 2022 1:06 PM 
    <details><summary>展开描述 ...</summary> 
    你还不知道可以用中文编写脚本制作游戏？Unity已经支持中文编辑器啦！还可以使用中文编程，那还不赶紧点进来看看~ 
    </details> 
<!-- juejin:END -->
### 少数派
