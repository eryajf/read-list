...
- 🎭 [哪里可以找到技术牛逼的老外开发，想花钱办点事，国内的牛逼的也行](https://www.v2ex.com/t/875432#reply10) | Thu Aug 25 2022 1:02 PM
- 🥷 [为什么 Macos 明明还有很多内存没用（我 32G 内存），却动不动提示软件内存不足呢？](https://www.v2ex.com/t/875424#reply25) | Thu Aug 25 2022 12:24 PM
- 🐵 [有破解数据算法的高手吗.有偿求助](https://www.v2ex.com/t/875420#reply6) | Thu Aug 25 2022 12:05 PM<!-- v2ex:END -->

### 掘金-全站热点

<!-- juejin:START -->
- 🤗 [Go&amp;Java算法之字符串解码](https://juejin.cn/post/7135829559257088031) | Thu Aug 25 2022 3:03 PM 
    <details><summary>展开描述 ...</summary> 
    携手创作，共同成长！这是我参与「掘金日新计划 · 8 月更文挑战」的第29天，点击查看活动详情 字符串解码 给定一个经过编码的字符串，返回它解码后的字符串。 编码规则为: k[encoded_stri 
    </details> 

- 🎡 [深入理解 D3.js 可视化库之力导向图原理与实现](https://juejin.cn/post/7135828614008242190) | Thu Aug 25 2022 2:59 PM 
    <details><summary>展开描述 ...</summary> 
    简介 D3.js 是一个基于 web 标准的 JS 可视化库，它借助 SVG、Canvas 和 HTML 进行数据可视化。在数据可视化中，我们很多时候会使用图来表达数据中所蕴含的信息，图方便让我们清晰 
    </details> 

- 🕯 [头脑风暴：二叉搜索树的最小绝对差](https://juejin.cn/post/7135828075580751903) | Thu Aug 25 2022 2:58 PM 
    <details><summary>展开描述 ...</summary> 
    题目 给你一棵所有节点为非负值的二叉搜索树，请你计算树中任意两节点的差的绝对值的最小值。 示例： 解题思路 根据题意，该二叉树是一棵二叉搜索树，所以我们可以用中序遍历的方式来遍历整棵二叉树，得到的将是 
    </details> 

- 🚀 [Flutter 系列（四）：Flutter 常用 Widget 二](https://juejin.cn/post/7135827895993237541) | Thu Aug 25 2022 2:57 PM 
    <details><summary>展开描述 ...</summary> 
    携手创作，共同成长！这是我参与「掘金日新计划 · 8 月更文挑战」的第4天，点击查看活动详情 前言 很高兴遇见你~ 在本系列的上一篇文章中，我们介绍了 Flutter 特点以及一些常用的 Widget 
    </details> 

- 💪 [B+树索引（9）之索引应用排序的注意事项](https://juejin.cn/post/7135827788322570271) | Thu Aug 25 2022 2:56 PM 
    <details><summary>展开描述 ...</summary> 
    携手创作，共同成长！这是我参与「掘金日新计划 · 8 月更文挑战」的第26天，点击查看活动详情 B+树索引（9）之索引应用排序的注意事项 前言 前面有两篇文章讲解了索引的适用场景，包含全值匹配、最左匹 
    </details> 
<!-- juejin:END -->
### 少数派
