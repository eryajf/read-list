...
<!-- v2ex:START -->
- 🥸 [这个技术太神奇了,是怎么实现的?](https://www.v2ex.com/t/873199#reply12) | Tue Aug 16 2022 6:04 AM
- 🤗 [Noptcha : 一个自动完成 CAPTCHA 的浏览器插件](https://www.v2ex.com/t/873187#reply2) | Tue Aug 16 2022 5:03 AM
- 🎭 [Google Voice 回收时间缩短至 30 天](https://www.v2ex.com/t/873186#reply28) | Tue Aug 16 2022 4:51 AM
- 🥷 [镜像网站数据库重启的疑问](https://www.v2ex.com/t/873174#reply0) | Tue Aug 16 2022 4:11 AM
- 🐵 [调查下有多少人想搞自己的 SaaS 系统?](https://www.v2ex.com/t/873173#reply5) | Tue Aug 16 2022 4:09 AM<!-- v2ex:END -->
...
- 🎡 [扫盲 CSS 中的单位](https://juejin.cn/post/7132322794733469710) | Tue Aug 16 2022 4:19 AM 
    <details><summary>展开描述 ...</summary> 
    在 CSS 中，对于尺寸属性的值一般可以分为以下几类： 关键字 数值 百分比 关键字一般有 initial、unset 等，百分比则是相对值，常见的是相对于上级 BFC 元素的比例。 当然还有包括纯数 
    </details> 

- 🕯 [「项目总结」特定业务场景数据收集，帮助解决用户具体操作无法确定的问题](https://juejin.cn/post/7132321345282506788) | Tue Aug 16 2022 4:09 AM 
    <details><summary>展开描述 ...</summary> 
    携手创作，共同成长！这是我参与「掘金日新计划 · 8 月更文挑战」的第18天，点击查看活动详情。今天跟大家分享一下如何进行特定业务场景数据收集，来帮助解决用户具体操作无法确定的问题。 
    </details> 

- 🚀 [来字节封装的第一个React组件：手机号自动校验格式FormItem](https://juejin.cn/post/7132310843689009160) | Tue Aug 16 2022 3:28 AM 
    <details><summary>展开描述 ...</summary> 
    来 字节跳动 封装的第一个React组件：自动校验手机号格式组件。封装复杂，暴露简单。支持334格式手机号码并自动去空格。使用较为宽松的正则格式，提高普适性。简化入参设计更易用。 
    </details> 

- 💪 [连流量染色都没有，你说要搞微服务？](https://juejin.cn/post/7132305924395368485) | Tue Aug 16 2022 3:10 AM 
    <details><summary>展开描述 ...</summary> 
    在当下盛行的微服务架构下，服务数量多导致的依赖问题经常会成为开发过程中的绊脚石。也经常会在各种技术交流会上听到类似的话题，大家都在积极的讨论这种问题如何去解决。于是决定给大家介绍下流量染色的原理以及能 
    </details> 
<!-- juejin:END -->
### 少数派
