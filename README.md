...
<!-- juejin:START -->
- 🤗 [提升UI产品体验的14个细节！你都知道吗？](https://juejin.cn/post/7122351958643933198) | Wed Jul 20 2022 7:23 AM 
    <details><summary>展开描述 ...</summary> 
    界面是用户在与任何产品、APP或平台交互时看到的内容，用户体验就是建立在坚实的界面设计基础之上的。所以，如果你想要在UI设计上提升能力，应该多去思考界面设计背后的原因。 今天会跟大家分享一些被广泛运用 
    </details> 

- 🎡 [我们用48h，合作创造了一款Web游戏：Dice Crush，参加国际赛事](https://juejin.cn/post/7122345627307999263) | Wed Jul 20 2022 6:59 AM 
    <details><summary>展开描述 ...</summary> 
    几个大厂小伙，有产品策划、有设计师、有程序员，合作创造游戏，48小时，能开发出什么游戏？快来看看我们艰辛的制作过程吧！ 
    </details> 

- 🕯 [用原生JS写一个简易版的台球](https://juejin.cn/post/7122337541281284126) | Wed Jul 20 2022 6:28 AM 
    <details><summary>展开描述 ...</summary> 
    突发奇想想用JS写一个台球小游戏，磕磕碰碰之后，算是实现了一个破产版的。用到的知识主要是通过递归来调用requestAnimationFrame，以及一些简单的三角函数角度计算。 
    </details> 

- 🚀 [【程序员的浪漫】七夕到了，还不快给你女朋友做一个专属chrome新标签页](https://juejin.cn/post/7122332008252080142) | Wed Jul 20 2022 6:05 AM 
    <details><summary>展开描述 ...</summary> 
    七夕节马上就要到了，作为拥有对象（没有的话，可以选择 new 一个出来）的程序员来说，肯定是需要有一点表示才行的。用钱能买到的东西不一定能表达咱们的心意，但是用心去写的代码，还能让对象每天看到那 
    </details> 

- 💪 [攻克作用域和闭包](https://juejin.cn/post/7122301461895217165) | Wed Jul 20 2022 4:07 AM 
    <details><summary>展开描述 ...</summary> 
    作用域和闭包是js学习中的一座大山，更是面试中的热点话题，理解了作用域和闭包的机制，在开发中能够更加游刃有余 
    </details> 
<!-- juejin:END -->
### 少数派
