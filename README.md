...
<!-- juejin:START -->
- 🤗 [分享10个国外云渲染服务平台](https://juejin.cn/post/7136212136597913607) | Fri Aug 26 2022 3:48 PM 
    <details><summary>展开描述 ...</summary> 
    元宇宙和5G都带动了 3D 技术的发展，扩展了 3D 的应用场景，让 3D 离我们的生活越来越近。随着 3D 技术的发展，促生出 3D 渲染需求的增加，5G 技术带来网络质量的提升，云渲染将会是一个大 
    </details> 

- 🎡 [Winform控件优化之圆角按钮【各种实现中的推荐做法】（下）](https://juejin.cn/post/7136205123441098765) | Fri Aug 26 2022 3:22 PM 
    <details><summary>展开描述 ...</summary> 
    最终优化实现ButtonPro按钮（继承自Button），既提供Button原生功能，又提供扩展功能，除了圆角以外，还实现了圆形、圆角矩形的脚尖效果、边框大小和颜色、背景渐变颜色... 
    </details> 

- 🕯 [【实践出真知】大文件分片上传及相关优化](https://juejin.cn/post/7136204969195077669) | Fri Aug 26 2022 3:21 PM 
    <details><summary>展开描述 ...</summary> 
    需求背景 关于分片上传，是个老生常谈的话题，但并不是每个项目中都会采用，为什么不用，以及为什么用，都是需要考虑清楚的。 上传文件往往需要走这么几个步骤： 判断类型 判断大小 拿到上传地址 往地址推送文 
    </details> 

- 🚀 [Go&amp;Java算法之至少有K个重复字符的最长子串](https://juejin.cn/post/7136203034983399432) | Fri Aug 26 2022 3:13 PM 
    <details><summary>展开描述 ...</summary> 
    携手创作，共同成长！这是我参与「掘金日新计划 · 8 月更文挑战」的第30天，点击查看活动详情 至少有K个重复字符的最长子串 给你一个字符串 s 和一个整数 k ，请你找出 s 中的最长子串， 要求该 
    </details> 

- 💪 [B+树索引（10）之回表的代价](https://juejin.cn/post/7136202381334675486) | Fri Aug 26 2022 3:10 PM 
    <details><summary>展开描述 ...</summary> 
    携手创作，共同成长！这是我参与「掘金日新计划 · 8 月更文挑战」的第27天，点击查看活动详情 B+树索引（10）之回表的代价 前言 什么是回表 回表操作一般发生在二级索引中，查询的列不全部包含在二级 
    </details> 
<!-- juejin:END -->
### 少数派
