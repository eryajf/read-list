...
<!-- juejin:START -->
- 🤗 [Go1.20 中两个关于 Time 的更新，终于不用背 2006-01-02 15:04:05 了！](https://juejin.cn/post/7166838025974988814) | Thu Nov 17 2022 4:32 AM 
    <details><summary>展开描述 ...</summary> 
...
- 🕯 [792. 匹配子序列的单词数 : 常规预处理优化匹配过程](https://juejin.cn/post/7166806856604581901) | Thu Nov 17 2022 2:31 AM 
    <details><summary>展开描述 ...</summary> 
    题目描述 这是 LeetCode 上的 792. 匹配子序列的单词数 ，难度为 中等。 Tag : 「二分」、「哈希表」 给定字符串 s 和字符串数组 words, 返回  words[i] 中是 s 
    </details> 

- 🚀 [实战Netty！基于私有协议，怎样快速开发网络通信服务？](https://juejin.cn/post/7166805003007426567) | Thu Nov 17 2022 2:24 AM 
    <details><summary>展开描述 ...</summary> 
    在工作中，我经常使用netty开发一些服务，掌握netty的工作原理，开发一些服务端以及客户端是非常简单，本篇文章，我们就以具体的协议来进行一个简单的服务的开发。 
    </details> 

- 💪 [贪心算法+动态规划 ｜ 眼光不同决定深度不同](https://juejin.cn/post/7166803488096124958) | Thu Nov 17 2022 2:18 AM 
    <details><summary>展开描述 ...</summary> 
    上大学那会有门课程叫做【算法与实践】, 算法配上 C++ 那感觉不要提多爽了。现在回想起来算法不局限于语言，只不过每个语言的语法不一罢了， 但是 
    </details> 
<!-- juejin:END -->
### 少数派
