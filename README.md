...
<!-- juejin:START -->
- 🤗 [Bitmap和Drawable 相关知识的扫盲](https://juejin.cn/post/7126798240573292558) | Mon Aug 01 2022 6:57 AM 
    <details><summary>展开描述 ...</summary> 
    Bitmap是什么 Bitmap的基本思想就是用一个bit位来标记某个元素对应的Value，而Key即是该元素。由于采用了Bit为单位来存储数据，因此在存储空间方面，可以大大节省。 Bitmap 是位 
    </details> 

- 🎡 [基于代数式设计构建 JSON 语法解析器](https://juejin.cn/post/7126797096031617038) | Mon Aug 01 2022 6:52 AM 
    <details><summary>展开描述 ...</summary> 
    基于 FP 范式设计一个 JSON 解析器。用代数式设计进行抽象：以关系代数描述类型，而非内在表现。 
    </details> 

- 🕯 [photoshop 2022 Mac/Win](https://juejin.cn/post/7126795763622871048) | Mon Aug 01 2022 6:47 AM 
    <details><summary>展开描述 ...</summary> 
    photoshop 2022是一款全球最大的图像处理软件，Photoshop可分为图画编辑、图画组成、校色调色及特效制造有些。图画编辑是图画处理的根底，可以对图画做各种变换如扩大、减小、旋转、歪斜、镜 
    </details> 

- 🚀 [Python 从结构化字符串中提取数据](https://juejin.cn/post/7126795114503995423) | Mon Aug 01 2022 6:46 AM 
    <details><summary>展开描述 ...</summary> 
    在许多自动化任务中，我们都需要从已知格式结构化的输入文本中提取相关信息。在本节中，我们将以提取电影评论数据信息为例讲解如何从结构化字符串中提取数据。 
    </details> 

- 💪 [一个简单的 Flutter 步进器计算组件](https://juejin.cn/post/7126794245918162975) | Mon Aug 01 2022 6:41 AM 
    <details><summary>展开描述 ...</summary> 
    前言 近期有个业务需求，涉及用户付费相关的计算，需要一个步进器计算组件，组件功能如下： 仅限支持整数，限制值范围 每次步进加累加 5 支持文本框手动输入，失去焦点后结果会自动校正为 5 的倍数... 
    </details> 
<!-- juejin:END -->
### 少数派
