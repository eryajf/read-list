...
<!-- juejin:START -->
- 🤗 [react-router-dom v6 详细使用示例](https://juejin.cn/post/7142141069096910855) | Sun Sep 11 2022 3:16 PM 
    <details><summary>展开描述 ...</summary> 
    一、基本使用 首先安装依赖 引入实现路由所需的组件，以及页面组件 path：路径 element：要渲染的组件 二、路由跳转 在跳转路由时，如果路径是/开头的则是绝对路由，否则为相对路由，即相对于当前 
    </details> 

- 🎡 [如何应对老板需求？](https://juejin.cn/post/7142136003774873636) | Sun Sep 11 2022 2:57 PM 
    <details><summary>展开描述 ...</summary> 
    所谓老板需求就是指老板想到个需求，直接告诉你什么时候需要做好的需求。这类需求，一般要的还比较急，希望我今天提出，明天你就能做出来。老板需求的特征：时间急、有需求说明，但不一定明确。 
    </details> 
