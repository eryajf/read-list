...
<!-- v2ex:START -->
- 🥸 [鬼才想法 issue 做 blog](https://www.v2ex.com/t/895641#reply2) | Wed Nov 16 2022 4:09 AM
- 🤗 [新西兰的 Tesla 车主新鲜出炉的 Model 3 故障](https://www.v2ex.com/t/895638#reply9) | Wed Nov 16 2022 4:00 AM
- 🎭 [求个性价比机场](https://www.v2ex.com/t/895634#reply4) | Wed Nov 16 2022 3:41 AM
- 🥷 [Python 新手语法问题，为什么用 str split 后新建 dict 爆黄呢？](https://www.v2ex.com/t/895631#reply11) | Wed Nov 16 2022 3:36 AM
- 🐵 [请教一下， nodejs/express 是如何处理多个请求的](https://www.v2ex.com/t/895617#reply9) | Wed Nov 16 2022 2:55 AM<!-- v2ex:END -->

### 掘金-全站热点

<!-- juejin:START -->
- 🤗 [s52.进程和计划任务](https://juejin.cn/post/7166436384306102285) | Wed Nov 16 2022 2:33 AM 
    <details><summary>展开描述 ...</summary> 
    1.每周的工作日1:30，将/etc备份至/backup目录中，保存的文件名称格式为&quot;etcbak-yyyy-mm-dd-HH.tar.xz&quot;，其中日期是前一天的时间 2.每两小时取出当前系统/pro 
    </details> 

- 🎡 [s51.shell脚本编程](https://juejin.cn/post/7166436258380513294) | Wed Nov 16 2022 2:33 AM 
    <details><summary>展开描述 ...</summary> 
    第七部分 1、每隔3秒钟到系统上获取已经登录的用户信息；如果发现用户hacker登录，则将登录时间和主机记录于日志/var/log/login.log中，并退出脚本 2、随机生成10以内的数字，实现猜 
    </details> 

- 🕯 [Android直播渲染卡顿原理分析](https://juejin.cn/post/7166215019049254925) | Tue Nov 15 2022 12:14 PM 
    <details><summary>展开描述 ...</summary> 
    Android直播间卡顿原理分析和监控。从UI层和流媒体层两个层面进行卡顿分析，从而推断出合理的卡顿监控方案。 
    </details> 

- 🚀 [优化实战 第54期 - 脱离正则的数字格式化](https://juejin.cn/post/7166190742170238984) | Tue Nov 15 2022 10:41 AM 
    <details><summary>展开描述 ...</summary> 
    数字格式化在日常开发中是特别普遍的需求。即在特定的业务场景对数字进行一定的格式化处理，以增强其阅读性 千位分隔符 基础示例 默认情况下，支持对 数值 和 字符串数值 进行 千位分隔 且 四舍五入 保留 
    </details> 

- 💪 [React组件的性能优化](https://juejin.cn/post/7166180718236663845) | Tue Nov 15 2022 10:02 AM 
    <details><summary>展开描述 ...</summary> 
    很多初学者对于React的性能优化可能知道个key，但是那仅仅是React性能优化的冰山一角~~~~ 
    </details> 
<!-- juejin:END -->
### 少数派
