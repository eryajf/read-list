...
<!-- v2ex:START -->
- 🥸 [Redis 缓存淘汰配置如何选？](https://www.v2ex.com/t/877698#reply1) | Sun Sep 04 2022 4:12 PM
- 🤗 [小米 watch S1 怎么开发应用？](https://www.v2ex.com/t/877696#reply1) | Sun Sep 04 2022 3:59 PM
- 🎭 [如何用 shell 脚本优雅的遍历文件夹内所有文件名的中文字符并替换？](https://www.v2ex.com/t/877692#reply19) | Sun Sep 04 2022 3:04 PM
- 🥷 [Edge 的 PDF 滚动拖影什么时候能改](https://www.v2ex.com/t/877686#reply2) | Sun Sep 04 2022 2:19 PM
- 🐵 [为什么游戏玩家少了就要关服？](https://www.v2ex.com/t/877671#reply25) | Sun Sep 04 2022 12:50 PM<!-- v2ex:END -->

### 掘金-全站热点

<!-- juejin:START -->
- 🤗 [十数行代码为你的网站添加语音小助手](https://juejin.cn/post/7139537924021813278) | Sun Sep 04 2022 2:55 PM 
    <details><summary>展开描述 ...</summary> 
    `Web Speech API` 除了语音输出外，还支持语音识别，你可以通过 `Web Speech API` 收集用户的语音指令，为你的网站添加一些有趣的功能：比如在小说阅读网站上添加语音指令，让你 
    </details> 

- 🎡 [HTTP 中的 Content-Type](https://juejin.cn/post/7139529540832854029) | Sun Sep 04 2022 2:21 PM 
    <details><summary>展开描述 ...</summary> 
    Content-Type 指定 Body 的媒体资源类型，如果是请求头，则代表请求体的资源类型，如果是响应头，则代表响应体的资源类型。 资源类型通过 MIME（Multipurpose Interne 
    </details> 

- 🕯 [如何评估需求优先级?](https://juejin.cn/post/7139527369601056775) | Sun Sep 04 2022 2:14 PM 
    <details><summary>展开描述 ...</summary> 
    项目的需求来源有很多方面，最终由产品经理整理出来哪些要做，哪些不做。我前面说过需求评审时，要讲清楚这次版本的目的是什么。这些要做的功能就是达成目的的手段。 
    </details> 

- 🚀 [要想实现分页查询，该怎么做呢](https://juejin.cn/post/7139517032391213086) | Sun Sep 04 2022 1:33 PM 
    <details><summary>展开描述 ...</summary> 
    一、是什么 在我们做数据查询的时候，如果数据量很大，比如几万条数据，放在一个页面显示的话显然不友好，这时候就需要采用分页显示的形式，如每次只显示10条数据 要实现分页功能，实际上就是从结果集中显示第1 
    </details> 

- 💪 [【前端组件化】系列文章第一篇——方案探究](https://juejin.cn/post/7139513166613970958) | Sun Sep 04 2022 1:18 PM 
    <details><summary>展开描述 ...</summary> 
