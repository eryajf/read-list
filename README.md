...
- 🧠 [科技爱好者周刊（第 228 期）：人类和人生的意义](http://www.ruanyifeng.com/blog/2022/10/weekly-issue-228.html) | Fri Oct 28 2022 12:11 AM<!-- ruanyf:END -->
...
- 🙉 [好工具周刊（第 37 期）: Eoapi, Tailwind CSS Gradient Generator, IconGo, 竹白专栏检索, ...](https://discuss-cn.bestxtools.com/d/91/1) | Thu Nov 10 2022 7:57 AM<!-- bestxtools:END -->
...
<!-- juejin:START -->
- 🤗 [前端工程化基建探索（5）Vite4.0.0都悄悄在“卷”出来了，是时候去探索Vite的设计和实现了](https://juejin.cn/post/7170288636921905183) | Sat Nov 26 2022 11:42 AM 
    <details><summary>展开描述 ...</summary> 
    从2021年2月份Vite2更新，到2022年7月份Vite3发布，到今年2022年11月份Vite 4.0.0-alpha.0出现，不得不说，Vite在改善前端开发体验的道路上越来越卷了 
    </details> 

- 🎡 [正则训练营 ｜ 3.正则中的位置信息：行首尾 + 单词边界 + 环视](https://juejin.cn/post/7170283508882440205) | Sat Nov 26 2022 11:24 AM 
    <details><summary>展开描述 ...</summary> 
    对于匹配而言，就像我们看一个人是不是自己要找的人，不只有对着画像、照片一直看这一个方法，也可以描述 TA 在什么东西的旁边、TA 面前是什么、背后是什么等等，这些位置信息在正则中同样有需求，并且有个 
    </details> 

- 🕯 [关于无感刷新Token，我是这样子做的](https://juejin.cn/post/7170278285274775560) | Sat Nov 26 2022 11:02 AM 
    <details><summary>展开描述 ...</summary> 
    JWT是目前最流行的跨域认证解决方案，通过使用Token获取服务器中对应的资源数据给客户端，但Token的有效时间是有限的，那你知道怎么在项目中做到无感刷新Token吗 
    </details> 

- 🚀 [MobPush for Flutter](https://juejin.cn/post/7170274114929147934) | Sat Nov 26 2022 10:46 AM 
    <details><summary>展开描述 ...</summary> 
    集成准备 这是一个基于 MobPush 功能的扩展的 Flutter 插件。使用此插件能够帮助您在使用 Flutter 开发应用时，快速地实现推送功能。 在pubspec.yaml文件中加入下面依赖  
    </details> 

- 💪 [技术周报·前端领域的插件式设计](https://juejin.cn/post/7170273634823929892) | Sat Nov 26 2022 10:44 AM 
    <details><summary>展开描述 ...</summary> 
    编辑推荐：前端领域的插件式设计；高并发架构设计经验总结；现代前端如何入门 3D 开发；Next.js 13新的实验性特性，实现App“动态无限制”等 
    </details> 
<!-- juejin:END -->
### 少数派
