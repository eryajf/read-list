...
<!-- juejin:START -->
- 🤗 [vue3开发拒绝cv, 快使用curd](https://juejin.cn/post/7127169214879629320) | Tue Aug 02 2022 6:56 AM 
    <details><summary>展开描述 ...</summary> 
    开发管理后台基本是企业的日常需求, 基本每个前台项目都必有一个后台项目跟着, 虽然是必需品, 但是大家好像有不是那么在意他, 毕竟只有管理员用, 今天我们讲一下&quot;增删改查&quot;组件:v-curd. v-c 
    </details> 

- 🎡 [玉溪卷烟厂通过正确选择时序数据库 轻松应对超万亿行数据](https://juejin.cn/post/7127165069460242445) | Tue Aug 02 2022 6:40 AM 
    <details><summary>展开描述 ...</summary> 
    玉溪卷烟厂设备采集点共有 36526 个，数据类型包总数据量轻松超过了万亿行。使用 TDengine 后即便是在三副本（数据存储三份确保高可用）的配置下，目前占用的总空间也仅有 1TB 左右。 
    </details> 

- 🕯 [我又又又把Kubernetes整理了一次](https://juejin.cn/post/7127164618908106765) | Tue Aug 02 2022 6:38 AM 
    <details><summary>展开描述 ...</summary> 
    携手创作，共同成长！这是我参与「掘金日新计划 · 8 月更文挑战」的第1天，点击查看活动详情 大家好，我是乔克。 人不是在折腾，就是在折腾的路上。 最近在整理一些笔记，发现之前记录的有些杂乱，所以又对 
    </details> 

- 🚀 [AI+BI+可视化，Sugar BI架构深度剖析](https://juejin.cn/post/7127163939128868895) | Tue Aug 02 2022 6:36 AM 
    <details><summary>展开描述 ...</summary> 
    本次内容主要分为以下 4 个部分：Sugar BI 产品的整体概况、可视化技术分析、智能图表推荐、智能语音交互。 
    </details> 

- 💪 [Spring Security-基于表达式的访问控制和基于注解的访问控制](https://juejin.cn/post/7127162884290789413) | Tue Aug 02 2022 6:32 AM 
    <details><summary>展开描述 ...</summary> 
    携手创作，共同成长！这是我参与「掘金日新计划 · 8 月更文挑战」的第6天，点击查看活动详情。 一、基于表达式的访问控制 1.access&lpar;&rpar;方法使用 之前学习的登录用户权限判断实际上底层实现都是调用 
    </details> 
<!-- juejin:END -->
### 少数派
