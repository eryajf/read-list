...
<!-- juejin:START -->
- 🤗 [都听说过 lodash，但你会用吗？](https://juejin.cn/post/7143579596217122853) | Thu Sep 15 2022 12:19 PM 
    <details><summary>展开描述 ...</summary> 
    都听说过 lodash，但是，你会在项目中使用它吗？你知道如何使用它吗？你知道它有哪些函数吗？快快来学吧。 
    </details> 

- 🎡 [分享两个简单好看的按钮悬停效果](https://juejin.cn/post/7143579495486717966) | Thu Sep 15 2022 12:18 PM 
    <details><summary>展开描述 ...</summary> 
    分享两个简单好看的按钮悬停效果。 利用 CSS 伪元素、伪类，结合 position 定位和 transition 的动画效果。 
    </details> 

- 🕯 [Memlab，一款分析 JavaScript 堆并查找浏览器和 Node.js 中内存泄漏的开源框架](https://juejin.cn/post/7143574359607607332) | Thu Sep 15 2022 11:59 AM 
    <details><summary>展开描述 ...</summary> 
    Memlab 是一款 E2E 测试和分析框架，用于发现 JavaScript 内存泄漏和优化机会。 Memlab 是 JavaScript 的内存测试框架。它支持定义一个测试场景（使用 Puppete 
    </details> 

- 🚀 [自动化测试哪家强？Apipost用实力来告诉你！](https://juejin.cn/post/7143569989197365255) | Thu Sep 15 2022 11:42 AM 
    <details><summary>展开描述 ...</summary> 
    测试的作用对于一个项目的重要性不言而喻，简单来说就是项目最后的把关者，一个项目的成功与否可能体现在很多种方面，但是如果过不去测试这一关，那前面的一切就是白扯～ 
    </details> 

- 💪 [[LeetCode] 无重复字符的最长子串 &amp; 最长回文子串](https://juejin.cn/post/7143567357976739847) | Thu Sep 15 2022 11:31 AM 
    <details><summary>展开描述 ...</summary> 
    前言 博主最近在看新的工作机会，也是在找一些leetcode上比较高频的算法复习一下，这里分享两道算法题的解题。 3. 无重复字符的最长子串 解题思路： 此题不难想到使用哈希表+快慢双指针来进行重复字 
    </details> 
<!-- juejin:END -->
### 少数派
