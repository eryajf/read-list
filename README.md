...
<!-- v2ex:START -->
- 🥸 [新手请教，关于操作列表的问题](https://www.v2ex.com/t/867751#reply2) | Thu Jul 21 2022 6:29 AM
- 🤗 [有个疑问: 为什么机械硬盘 3.5 需要额外供电 2.5 不需要?](https://www.v2ex.com/t/867747#reply2) | Thu Jul 21 2022 6:25 AM
...
- 🐵 [Gopher 我们一起来造个 ORM 吧!](https://www.v2ex.com/t/867712#reply11) | Thu Jul 21 2022 3:36 AM<!-- v2ex:END -->

### 掘金-全站热点

<!-- juejin:START -->
- 🤗 [如何实现带timeout的input？](https://juejin.cn/post/7122699052554125342) | Thu Jul 21 2022 5:51 AM 
    <details><summary>展开描述 ...</summary> 
    我们知道，在Python里面，可以使用input获取用户的输入。例如： 但有一个问题，如果你什么都不输入，程序会永远卡在这里。有没有什么办法，可以给input设置超时时间呢？如果用户在一定时间内不输入 
    </details> 

- 🎡 [统计千行代码Bug率，有没有意义？](https://juejin.cn/post/7122697794053210120) | Thu Jul 21 2022 5:45 AM 
    <details><summary>展开描述 ...</summary> 
    我的结论是：统计Bug率有意义。但是统计千行代码Bug率没有意义。 为什么千行代码Bug率是没有意义的？ 某公司最近出了一个方案，用来量化程序员的工作绩效。叫做千行代码Bug率。在一个统计周期内，程序 
    </details> 
