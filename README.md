...
<!-- v2ex:START -->
- 🥸 [学习 React+TypeScript 应该怎么上手？](https://www.v2ex.com/t/868346#reply3) | Sun Jul 24 2022 5:50 AM
- 🤗 [这个正则要怎么写呢？一个不标准的 json 字符串，想要手动给他修改正确](https://www.v2ex.com/t/868341#reply0) | Sun Jul 24 2022 4:49 AM
- 🎭 [bilibili lua BUG 本地未复现](https://www.v2ex.com/t/868332#reply3) | Sun Jul 24 2022 4:00 AM
- 🥷 [凉心云的 Serverless 云函数如果不用，记得冻结服务不然每天都会扣费](https://www.v2ex.com/t/868328#reply5) | Sun Jul 24 2022 3:47 AM
- 🐵 [关于是否跳槽，大家给点建议](https://www.v2ex.com/t/868327#reply8) | Sun Jul 24 2022 3:27 AM<!-- v2ex:END -->
...
- 🚀 [MVCC多版本并发控制机制](https://juejin.cn/post/7123548364100075528) | Sat Jul 23 2022 12:46 PM 
    <details><summary>展开描述 ...</summary> 
    MVCC多版本并发控制机制 Mysql在可重复读隔离级别下如何保证事务较高的隔离性，我们上节课给大家演示过，同样的sql查询语句在一个事务里多次执行查询结果相同，就算其它事务对数据有修改也不会影响当前 
    </details> 
