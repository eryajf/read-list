...
<!-- juejin:START -->
- 🤗 [k8s 服务升级为啥 pod 会部署到我们不期望的节点上？？看来你还不懂污点和容忍度](https://juejin.cn/post/7170259811660431374) | Sat Nov 26 2022 9:50 AM 
    <details><summary>展开描述 ...</summary> 
    本文正在参加 「金石计划 . 瓜分6万现金大奖」 做自动化的同事今天居然问我 k8s 中为什么我部署的 pod 会跑到你们开发的节点上来？我可以去控制它吗？🧐🧐 兄弟，自然是可以控制的，接下来我详细给 
    </details> 

- 🎡 [前端如何主导ddd架构落地（下）](https://juejin.cn/post/7170258882885845028) | Sat Nov 26 2022 9:47 AM 
    <details><summary>展开描述 ...</summary> 
    前文提到ddd架构已经需要前端来救场了，此情此景，已经不知道尴尬的应该是后端、技术经理还是前端了，反正程序员一定是很尴尬。标题就是为了吸引眼球的，纯前端如果不是特别闲，是无论如何也不会干这事的。 
    </details> 

- 🕯 [下一代智能合约编程语言Move（四）](https://juejin.cn/post/7170249222019612686) | Sat Nov 26 2022 9:09 AM 
    <details><summary>展开描述 ...</summary> 
    背景 之前的文章我们已经介绍了Move的模块和函数，接下来将会介绍一些Move的特性。 结构体 结构体是用户自定义的拥有复杂数据的数据类型，它可以简单理解为一个key——value形式的存储器，key 
    </details> 

- 🚀 [视频缓存加速，2.5倍优化](https://juejin.cn/post/7170246151482900493) | Sat Nov 26 2022 8:57 AM 
    <details><summary>展开描述 ...</summary> 
    视频缓存已经成为各大视频App的标配，并且从功能使用数据来看，每个月使用的量都很大。所以，做好缓存功能的优化，对提升用户体验有非常重要的作用。 
    </details> 

- 💪 [Nacos配置中心1-配置文件的加载](https://juejin.cn/post/7170244688329474079) | Sat Nov 26 2022 8:52 AM 
    <details><summary>展开描述 ...</summary> 
    Nacos配置文件的加载，共享配置，扩展配置，当前自身应用配置，加载的优先级本地配置&gt;远程配置&gt;快照配置。 
    </details> 
<!-- juejin:END -->
### 少数派
