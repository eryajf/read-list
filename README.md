...
<!-- juejin:START -->
- 🤗 [快应用安卓机进行真机调试（详细流程）](https://juejin.cn/post/7140532531668975630) | Wed Sep 07 2022 7:14 AM 
    <details><summary>展开描述 ...</summary> 
    在开发快应用时，需要进行真机调试，因为在模拟器上很多效果都不正确，所以需要以真机为主。 快应用调试器、快应用预览版 下载地址，这两个测试手机上都要有，快应用调试器 是用来下载 rpk 的，然后会调起  
    </details> 

- 🎡 [大厂产品为何集体下架](https://juejin.cn/post/7140524773712330783) | Wed Sep 07 2022 6:43 AM 
    <details><summary>展开描述 ...</summary> 
    快手一个 30 多人的产品团队每月开销上百万，其中技术、产品和运营是开支大头。如果碰上产品商业化能力不行，那这就是铁亏。 昨天看了Tech星球发表的一篇文章，说的是各互联网大厂集中下架 60 多款 A 
    </details> 

- 🕯 [JDK动态代理实现原理以及手写实现JDK动态代理](https://juejin.cn/post/7140519841558954021) | Wed Sep 07 2022 6:25 AM 
    <details><summary>展开描述 ...</summary> 
    JDK动态代理是采用字节重组，重新生成对象来替代原始对象，以达到动态代理的目的。在理清楚JDK动态代理的过程后，手写实现JDK动态代理过程。 
    </details> 

- 🚀 [Elasticsearch：从零开始构建一个定制的分词器](https://juejin.cn/post/7140519648365608973) | Wed Sep 07 2022 6:23 AM 
    <details><summary>展开描述 ...</summary> 
    Elasticsearch 提供了大量的 analyzer 和 tokenizer 来满足开箱即用的一般需求。 有时，我们需要通过添加新的分析器来扩展 Elasticsearch 的功能。尽管 Ela 
    </details> 

- 💪 [Vue 2 阅读理解（十八）之响应式系统（四）](https://juejin.cn/post/7140516806321504292) | Wed Sep 07 2022 6:12 AM 
    <details><summary>展开描述 ...</summary> 
