...
<!-- juejin:START -->
- 🤗 [如何使用并查集解决朋友圈问题？](https://juejin.cn/post/7143880364233064455) | Fri Sep 16 2022 7:44 AM 
    <details><summary>展开描述 ...</summary> 
    今天分享到的是一种相对冷门的数据结构 —— 并查集。虽然冷门，但是它背后体现的算法思想却非常精妙，在处理特定问题上能做到出奇制胜。那么，并查集是用来解决什么问题的呢？ 
    </details> 

- 🎡 [面试官为啥总是嘴上挂着低耦合高复用?](https://juejin.cn/post/7143873919412355109) | Fri Sep 16 2022 7:19 AM 
    <details><summary>展开描述 ...</summary> 
    灵魂三问，对于相同功能，不同业务场景下的组件，你是否每次都使出必杀技copy大法？你是否有时会质疑自己为啥做了很多工作，却成长不大？面对面试官跟你提及低耦合、高复用，你是否嗤之以鼻不屑一顾？ 
    </details> 

- 🕯 [Java8 各种集合的 Stream 操作示例](https://juejin.cn/post/7143873350752796679) | Fri Sep 16 2022 7:18 AM 
    <details><summary>展开描述 ...</summary> 
    前言 本篇文章是个笔记篇......其实专门是写给同事的，他说他不会用 Java8 之后的 lambda 操作，这 Java18 都出来了，你 Java8 还没玩熟，这真是狗听了都摇摇头啊 吐槽 不愿 
    </details> 

- 🚀 [vue2源码解析（四）：依赖收集](https://juejin.cn/post/7143870723768418341) | Fri Sep 16 2022 7:07 AM 
    <details><summary>展开描述 ...</summary> 
    我报名参加金石计划1期挑战——瓜分10万奖池，这是我的第1篇文章，点击查看活动详情。实现数据的依赖收集，数据变化自动更新视图。 
    </details> 
