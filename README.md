...
<!-- juejin:START -->
- 🤗 [TS 泛型推断好难啊，看看你能写出来不](https://juejin.cn/post/7131972405131984933) | Mon Aug 15 2022 5:36 AM 
    <details><summary>展开描述 ...</summary> 
    最近做东西都在用ts，有时候写比较复杂的功能，如果不熟悉，类型写起来还是挺麻烦的。有这样一个功能，在这里，我们就不以我们现有的业务来举例了，我们还是已`Animal`举例，来说明场景。 
    </details> 

- 🎡 [什么是PWA呢？](https://juejin.cn/post/7131970671848423431) | Mon Aug 15 2022 5:29 AM 
    <details><summary>展开描述 ...</summary> 
    或许你可能已经听过这个名词,但是很多人很难说出它的含义. 其实我们一般会认为渐进式网页应用&lpar;Progressive Web Application&rpar;是一种术语,也就是指[「一些功能」添加在浏览器中运行 
    </details> 

- 🕯 [人非圣贤孰能无过,Go lang1.18入门精炼教程，由白丁入鸿儒，Go lang错误处理机制EP11](https://juejin.cn/post/7131968963868622878) | Mon Aug 15 2022 5:24 AM 
    <details><summary>展开描述 ...</summary> 
    在编程语言层面，错误处理方式大体上有两大流派，分别是以Python为代表的异常捕获机制&lpar;try....catch&rpar;；以及以Go lang为代表的错误返回机制&lpar;return error&rpar; 
    </details> 

- 🚀 [千万不要在方法上打断点！有大坑！](https://juejin.cn/post/7131956856771051557) | Mon Aug 15 2022 4:37 AM 
    <details><summary>展开描述 ...</summary> 
    我上周遇到了一个莫名其妙的搞心态的问题，浪费了我好几个小时。 气死我了，拿这几个小时来敲（摸）代（摸）码（鱼）不香吗？ 主要是最后问题的解决方式也让我特别的无语，越想越气，写篇文章 
    </details> 

- 💪 [js打印预览内容/文字被截断问题](https://juejin.cn/post/7131956410652295205) | Mon Aug 15 2022 4:34 AM 
    <details><summary>展开描述 ...</summary> 
    已知的问题 表格某个行的文字被截成了两半，一半在上一页的底部，一半在上一页的顶部 某页底部的文字或图片被截断成了两半，一半在上一页的底部，一半在上一页的顶部 解决方案 首先明确一点，如果是分页显示的话 
    </details> 
<!-- juejin:END -->
### 少数派
