...
<!-- v2ex:START -->
- 🥸 [问问大家有没有啥适合二次开发的 K8s 管理平台吗？](https://www.v2ex.com/t/875717#reply2) | Fri Aug 26 2022 2:51 PM
- 🤗 [有没有逆向大佬，来一个](https://www.v2ex.com/t/875712#reply0) | Fri Aug 26 2022 2:30 PM
- 🎭 [为什么 kubeadm 证书有效期只有 1 年？](https://www.v2ex.com/t/875706#reply3) | Fri Aug 26 2022 2:13 PM
- 🥷 [老哥们有没有啥方法能开这个 Google one](https://www.v2ex.com/t/875704#reply0) | Fri Aug 26 2022 1:58 PM
- 🐵 [问一个关于不同目录结构的项目，如何进行开发的基础问题](https://www.v2ex.com/t/875703#reply0) | Fri Aug 26 2022 1:49 PM<!-- v2ex:END -->

### 掘金-全站热点

<!-- juejin:START -->
- 🤗 [JavaScript 代理模式与策略模式](https://juejin.cn/post/7136193221796823071) | Fri Aug 26 2022 2:34 PM 
    <details><summary>展开描述 ...</summary> 
    代理模式 代理模式介绍 代理，顾名思义就是帮助别人做事，代理模式（Proxy），为其他对象提供一种代理以控制对这个对象的访问。 代理模式非常有意义，在生活中可以找到很多代理模式的场景，例如：明星都会有 
    </details> 

- 🎡 [【Matplotlib数据可视化】绘制柱状图](https://juejin.cn/post/7136192012901941256) | Fri Aug 26 2022 2:30 PM 
    <details><summary>展开描述 ...</summary> 
    携手创作，共同成长！这是我参与「掘金日新计划 · 8 月更文挑战」的第27天，点击查看活动详情 1. 柱状图绘制 首先，我们简单回顾一下柱状图大体内容以及Matplotlib库中的相应语法。 柱状图： 
    </details> 

- 🕯 [头脑风暴：二叉搜索树中的众数](https://juejin.cn/post/7136191211487887374) | Fri Aug 26 2022 2:27 PM 
    <details><summary>展开描述 ...</summary> 
    题目 给定一个有相同值的二叉搜索树（BST），找出 BST 中的所有众数（出现频率最高的元素）。 假定 BST 有如下定义： 结点左子树中所含结点的值小于等于当前结点的值 结点右子树中所含结点的值大于 
    </details> 

- 🚀 [牛客小白月赛56：E、阿宁睡大觉](https://juejin.cn/post/7136188935331381285) | Fri Aug 26 2022 2:18 PM 
    <details><summary>展开描述 ...</summary> 
    携手创作，共同成长！这是我参与「掘金日新计划 · 8 月更文挑战」的第28天，点击查看活动详情 阿宁经常在周末睡大觉。阿宁在膜法书上了解到，她睡觉时会产生字符串 s，计算出她的睡觉质量为  其中定义  
    </details> 

- 💪 [如何使用 JavaScript 将多张 GIF 图合成为一张 GIF 图](https://juejin.cn/post/7136186618397851685) | Fri Aug 26 2022 2:09 PM 
    <details><summary>展开描述 ...</summary> 
    1. 解析 DOM 中包含的 GIF 2. 重新生成 GIF 的每一帧图 问题：多个 GIF 素材时长不一致，如何保证同时结束？ 
    </details> 
<!-- juejin:END -->
### 少数派
