...
<!-- juejin:START -->
- 🤗 [OTAKU-UI组件库的年度总结](https://juejin.cn/post/7126743875745480734) | Mon Aug 01 2022 3:26 AM 
    <details><summary>展开描述 ...</summary> 
    组件库从创建项目到现在也经历了一年的时间了，也顺便刚给组件库来个年度总结吧，虽然并没有什么人用，也并没有发布。 在这一年共产生了 123 个 commit 总共收到了一个 issue 总共有 3 个用 
    </details> 

- 🎡 [Chrome操作指南——入门篇（二）](https://juejin.cn/post/7126743104962428942) | Mon Aug 01 2022 3:23 AM 
    <details><summary>展开描述 ...</summary> 
    在我们进行前端代码调试的时候，往往会通过 `console.log&lpar;&#39;彼时彼刻嵌入此时此刻&#39;&rpar;`进行输出日志，来查看代码的信息，或根据报错信息，对代码进行调整。而因此必定会涉及对信息的复制，以此报错信 
    </details> 

- 🕯 [【转载】UE4学习笔记：基础光照入门](https://juejin.cn/post/7126742714401423397) | Mon Aug 01 2022 3:22 AM 
    <details><summary>展开描述 ...</summary> 
    本随笔介绍 UE4 里关于光照、阴影和反射效果的特点和之间的区别。该笔记整理自官方在线教程：光照基础概念和效果。 光照的分类 UE4 引擎里的光源根据其可移动性可分为静态（Static）光源、固定（S 
    </details> 

- 🚀 [被报表需求逼疯的银行数据人，是时候放弃用Excel做报表了](https://juejin.cn/post/7126740257587871781) | Mon Aug 01 2022 3:13 AM 
    <details><summary>展开描述 ...</summary> 
    在银行干了几年数据分析，实在忍不住吐槽，这可以说是最没话语权，但脏活累活不断的部门。在银行，谁赚钱多谁就强势、嗓门大，赚钱多的业务部门基本上今天提业务指标需求，明天就得要做好分析。但科技人员响应需要流 
    </details> 

- 💪 [拿什么拯救你，小趴菜程序员！](https://juejin.cn/post/7126740528799940638) | Mon Aug 01 2022 3:13 AM 
    <details><summary>展开描述 ...</summary> 
    携手创作，共同成长！这是我参与「掘金日新计划 · 8 月更文挑战」的第3天，点击查看活动详情 当今社会的发展 对于 程序猿的要求也越来越高 不再仅仅是需要 身强力壮的搬砖工 企业更喜欢的是内功深厚的高 
    </details> 
<!-- juejin:END -->
### 少数派
