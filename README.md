...
<!-- v2ex:START -->
- 🥸 [mysql 并发更新某个字段引发的问题和思考](https://www.v2ex.com/t/891847#reply9) | Tue Nov 01 2022 9:46 AM
...
- 🥷 [内网服务开放外网映射后， PUT/DELETE 方法被 net::ERR_CONNECTION_RESET。该如何设置服务器允许 PUT/DELETE 方法？](https://www.v2ex.com/t/891810#reply6) | Tue Nov 01 2022 8:16 AM
- 🐵 [双十一海外云服务器只要 20/月（良心云）？](https://www.v2ex.com/t/891807#reply3) | Tue Nov 01 2022 8:02 AM<!-- v2ex:END -->

### 掘金-全站热点

<!-- juejin:START -->
- 🤗 [货拉拉用户 iOS 端卡顿优化实践](https://juejin.cn/post/7160951025782751263) | Tue Nov 01 2022 7:47 AM 
    <details><summary>展开描述 ...</summary> 
    前言 卡顿优化一直是客户端性能治理的重要方向之一，在这之前，我们先来解释下什么是卡顿。 卡顿，直白来说就是用户在使用APP的过程中能感受到界面一卡一卡的不流畅。从原理来说，就是在用户能够感知的视觉场景 
    </details> 

- 🎡 [NVM：管理不同node版本](https://juejin.cn/post/7160950002821365767) | Tue Nov 01 2022 7:43 AM 
    <details><summary>展开描述 ...</summary> 
    最近想看看vite加vue3,然后就看到使用vite最低node版本是14.8+了。但是直接装新node又害怕以前的项目有问题。这个时候看到了nvm。不得不说这玩意真香。具体使用方法都在文内，尽情享用 
    </details> 

- 🕯 [Pytest测试框架一键动态切换环境思路及方案](https://juejin.cn/post/7160937841374003214) | Tue Nov 01 2022 6:56 AM 
    <details><summary>展开描述 ...</summary> 
    利用Pytest fixture及conftest实现一套测试脚本，能根据环境进行自动化的配置，省去手动配置参数的步骤，可以实现在多环境中运行，从而快速验证各个接口及相关服务在不同环境中的表现。 
    </details> 

- 🚀 [测试右移-后台服务监控告警实践](https://juejin.cn/post/7160935017504309261) | Tue Nov 01 2022 6:45 AM 
    <details><summary>展开描述 ...</summary> 
    基于“测试右移”思想，开展的一次后台服务监控告警的实践记录总结。作为测试人员，除了要完成项目测试的基本工作，还应当能够及时跟进问题反馈、了解问题背后的真实原因、参与讨论解决方案，变被动为主动 
    </details> 

- 💪 [求解器：助力智能决策的利器](https://juejin.cn/post/7160934522698072094) | Tue Nov 01 2022 6:43 AM 
    <details><summary>展开描述 ...</summary> 
    求解器在现实生产生活中具有重要价值和意义。在世界一流的企业供应链管理软件，包括结合了运筹优化技术的APS、TMS等企业决策软件中，都能见到求解器的身影。那求解器是什么，又能做什么？ 
    </details> 
<!-- juejin:END -->
### 少数派
