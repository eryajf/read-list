...
- 🚀 [Nest 中的 Session 管理](https://juejin.cn/post/7343499296929988634) | Thu Mar 07 2024 3:49 PM 
    <details><summary>展开描述 ...</summary> 
    本文介绍了在基于 HTTP 的网络通信中，如何使用 Session 和 Cookie 来记录用户状态。我们详细讲解了 Nest.js 框架下 Session 的工作流程、配置方法以及在控制器中的使用。 
    </details> 

- 💪 [Nest 中的 Cookie 管理](https://juejin.cn/post/7343484473185697829) | Thu Mar 07 2024 3:47 PM 
    <details><summary>展开描述 ...</summary> 
    本文详细介绍了在 Nest.js 框架中如何使用和管理 Cookie。然后逐步演示了如何在 Nest.js 应用程序中安装和配置 cookie-parser 中间件，以及如何读取和设置 Cookie。 
    </details> 
<!-- juejin:END -->
### 少数派
