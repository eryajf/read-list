...
- 🤗 [都 2022 年了， coloros 后台还是只能允许 5 个 app 自启动](https://www.v2ex.com/t/875879#reply0) | Sat Aug 27 2022 1:53 PM
- 🎭 [utools 中的 json 格式化插件有没有其他替代品？](https://www.v2ex.com/t/875873#reply10) | Sat Aug 27 2022 1:35 PM
- 🥷 [immer 库处理 Map 的接口是不是有问题？](https://www.v2ex.com/t/875864#reply1) | Sat Aug 27 2022 12:18 PM
- 🐵 [gdb 有没有办法像 zsh 的 auto-suggestion 那样按一个键就出来之前的历史记录？每次重新输入指令太麻烦了](https://www.v2ex.com/t/875863#reply1) | Sat Aug 27 2022 12:17 PM<!-- v2ex:END -->

### 掘金-全站热点

<!-- juejin:START -->
- 🤗 [LeetCode数组中两元素的最大乘积使用JavaScript解题|前端学算法](https://juejin.cn/post/7136553705494544420) | Sat Aug 27 2022 1:54 PM 
    <details><summary>展开描述 ...</summary> 
    使用JavaScript解决LeetCode算法数组中两元素的最大乘积的问题，前端学算法，三分钟学会一个知识点 
    </details> 

- 🎡 [C# 使用秒表类Stopwatch对程序的运行速度测试](https://juejin.cn/post/7136553691158413349) | Sat Aug 27 2022 1:54 PM 
    <details><summary>展开描述 ...</summary> 
    携手创作，共同成长！这是我参与「掘金日新计划 · 8 月更文挑战」的第26天，点击查看活动详情 前言 你知道C#运行一个一百次循环要多久吗，一千次，一万次呢？今天这篇文章我们对这个问题去探索一下，顺便 
    </details> 

- 🕯 [用go实现Redis读写分离](https://juejin.cn/post/7136549213533700109) | Sat Aug 27 2022 1:36 PM 
    <details><summary>展开描述 ...</summary> 
    本篇文章将介绍Redis通信协议RESP, 而后在使用go来编写一个中间件，从而来完成Redis读写分离。 
    </details> 

- 🚀 [YOLOV:图像对象检测器在视频对象检测方面表现也很不错](https://juejin.cn/post/7136548049752424485) | Sat Aug 27 2022 1:32 PM 
    <details><summary>展开描述 ...</summary> 
    与传统的两段pipeline不同，论文提出了在一段检测之后再进行区域级的选择，避免了处理大量低质量的候选区域。此外，还构建了一个新的模块来评估目标帧与参考帧之间的关系，并指导聚合。 
    </details> 

- 💪 [Audio Unit框架（一）框架认识和使用](https://juejin.cn/post/7136546202320896014) | Sat Aug 27 2022 1:28 PM 
    <details><summary>展开描述 ...</summary> 
...
- 💼 [分析、AI和机器人技术帮助MLB球队距离完美投球机又近了一步](https://www.cnbeta.com/articles/tech/1309447.htm) | Sat Aug 27 2022 2:13 PM 
    <details><summary>展开描述 ...</summary> 
     &lt;p&gt;第一台棒球投球机可以追溯到100多年前。很明显，自从那台以火药为燃料的机器在普林斯顿大学首次亮相后，事情已经有了长足的发展，但大多数现代系统或多或少都是如此。一个球被手动或机械地扔进一个或多个旋转的轮子里，轮子将它高速地推向打手。&lt;/p&gt; &lt;a href=&quot;https://www.cnbeta.com/articles/tech/1309447.htm&quot; target=&quot;_blank&quot;&gt;&lt;strong&gt;阅读全文&lt;/strong&gt;&lt;/a&gt;  
    </details> 
