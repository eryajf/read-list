...
- 🕯 [eBPF 介绍](https://coolshell.cn/articles/22320.html) | Sat Dec 10 2022 2:38 AM<!-- coolshell:END -->
...
- 🐘 [关于时间管理的一点新的感悟](https://www.raychase.net/7384) | Sun Aug 27 2023 5:28 AM<!-- raychase:END -->
...
<!-- v2ex:START -->
- 🥸 [终于轮到我了，求推荐一款安卓手机](https://www.v2ex.com/t/1018302#reply17) | Sun Feb 25 2024 11:00 AM
- 🤗 [有熟悉网络的大神帮解释下 hyper-v 虚拟交换机吗， 或者有相关信息网址也行啊](https://www.v2ex.com/t/1018292#reply3) | Sun Feb 25 2024 9:28 AM
- 🎭 [前端开发现在遇到一些 android 开发的需求，有哪些比较好的教程可以快速学习下？](https://www.v2ex.com/t/1018287#reply5) | Sun Feb 25 2024 8:33 AM
- 🥷 [求深圳公司注册代理记账和挂靠靠谱商家推荐](https://www.v2ex.com/t/1018273#reply5) | Sun Feb 25 2024 7:37 AM
- 🐵 [写了一个可以自动压缩剪贴板图片的工具 解决 Windows 高分屏截图发不出去的问题 v4.2 重构](https://www.v2ex.com/t/1018259#reply5) | Sun Feb 25 2024 6:25 AM<!-- v2ex:END -->

### 掘金-全站热点

<!-- juejin:START -->
- 🤗 [历时3个月，代码开源了，给所有想入门AI视觉的朋友](https://juejin.cn/post/7339085624837193738) | Sun Feb 25 2024 1:02 PM 
    <details><summary>展开描述 ...</summary> 
    去年 11 的时候，给自己了一个目标，希望在未来的 3个月时间里，写满100篇关于从零入门AI视觉的算法、代码文字。 历经 3 个月，终于在今天 100 篇文章写完了，代码也全部调试完成，上传到 gi 
    </details> 

- 🎡 [Java 过滤器深入了解学习](https://juejin.cn/post/7339364757386215460) | Sun Feb 25 2024 12:59 PM 
    <details><summary>展开描述 ...</summary> 
    在Java中，过滤器（Filter）是一种用于在Servlet容器中对请求和响应进行预处理和后处理的组件。过滤器可以用于执行一系列的任务，例如修改请求和响应的内容、验证用户身份、日志记录等。它们是Ja 
    </details> 

- 🕯 [2013年蓝桥杯省赛A组填空题    1.排它平方数  知识点：暴力枚举](https://juejin.cn/post/7339016190612619264) | Sun Feb 25 2024 12:54 PM 
    <details><summary>展开描述 ...</summary> 
    1.排它平方数 - 蓝桥云课 &lpar;lanqiao.cn&rpar; 这是我写的，跑不出来结果： 思想是把x和x*x全部拆分，放到vector1，vector2里，然后遍历vector1，vector2，如果vec 
    </details> 

- 🚀 [函数式编程与MVI的美妙结合](https://juejin.cn/post/7339024907718344767) | Sun Feb 25 2024 12:50 PM 
    <details><summary>展开描述 ...</summary> 
    介绍一下函数式编程与MVI的美妙结合，它的思想与MVI的架构思想如此契合，进一步探索一下函数式编程在逻辑层的可能性。 
    </details> 

- 💪 [这都快React19了，快来学习一下服务端渲染吧！🦧🦧🦧](https://juejin.cn/post/7339042939602108468) | Sun Feb 25 2024 12:36 PM 
    <details><summary>展开描述 ...</summary> 
    前端工程师的工作范畴其实不仅仅局限在客户端浏览器，特别是在处理性能优化问题时，往往需要站在全栈的角度去审视系统的每个细节。 随着前端技术的演进，Vue、React 等现代前端框架的出现，不但让大型项目 
    </details> 
<!-- juejin:END -->
### 少数派
...
<!-- iui:START -->
- 🌊 [2024 年 2 月 每日分享](https://iui.su/182/) | Wed Feb 21 2024 3:56 AM 
    <details><summary>展开描述 ...</summary> 
    可以收藏「不死鸟发布页」dalao.ru ，速记：大佬点入 关于不死鸟每日分享栏目发现一些不错的资源，你有好的发现点击这里快速投稿，如需图文或其它建议可在这里回复反馈。2月21日空痕音乐下载一款... 
    </details> 

- 🫣 [益达yida新一代全平台聚合神器](https://iui.su/2016/) | Mon Feb 19 2024 5:11 AM 
    <details><summary>展开描述 ...</summary> 
    Yida益达是一款免费开源多平台聚合神器，集合追剧、小说、漫画、听书、图片、视频、RSS等，和iOS的香色闺阁差不多。益达下载仅用作国内加速下载用途，下载地址来自：github/yidaRule... 
    </details> 

- 🌜 [免费的离线下载神器](https://iui.su/2014/) | Mon Feb 19 2024 4:55 AM 
    <details><summary>展开描述 ...</summary> 
    安卓下载器下载速度比较快的安卓下载器，由多位不死鸟网友分享。 @张自来 @唯唯 幻影下载可以边下边播。2月19日新增一个速度下载APP，支持56种类型资源的下载，支持边下边播。2月4日新增了一个... 
    </details> 
...
- 🚦 [手机大流量卡](https://iui.su/3406/) | Fri Feb 02 2024 6:14 AM 
    <details><summary>展开描述 ...</summary> 
    办理链接来自官方代理渠道，可以放心办理。办理前需先看常见问题帮助，以免出现问题。 精选套餐内的套餐审核快，最快当日发货在线办理上面套餐感觉不合适可以看：更多大流量套餐/联通套餐/电信套餐/移动套... 
    </details> 
<!-- iui:END -->
