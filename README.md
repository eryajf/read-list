...
- 🎭 [求深圳公司注册代理记账和挂靠靠谱商家推荐](https://www.v2ex.com/t/1018273#reply4) | Sun Feb 25 2024 7:37 AM
- 🥷 [写了一个可以自动压缩剪贴板图片的工具 解决 Windows 高分屏截图发不出去的问题 v4.2 重构](https://www.v2ex.com/t/1018259#reply4) | Sun Feb 25 2024 6:25 AM
- 🐵 [[教程] 随时随地通过域名远程访问 nas、openwrt、alist 等家庭内网设备](https://www.v2ex.com/t/1018238#reply9) | Sun Feb 25 2024 3:44 AM<!-- v2ex:END -->

### 掘金-全站热点

<!-- juejin:START -->
- 🤗 [弹性布局详解](https://juejin.cn/post/7339085624836767754) | Sun Feb 25 2024 11:35 AM 
    <details><summary>展开描述 ...</summary> 
    弹性布局是css的一种布局方式，可以完整响应式的实现页面的布局，这里的响应式指的是可随页面变大变小，弹性容器中默认存在两条轴，主轴和交叉轴，主轴默认为x轴 依旧是拿ul和三个li为例 默认效果如下 现 
    </details> 

- 🎡 [面了这么多天，该做总结了-CSS篇&lpar;二&rpar;](https://juejin.cn/post/7339364757385887780) | Sun Feb 25 2024 11:33 AM 
    <details><summary>展开描述 ...</summary> 
    浅聊一下 书接上文，上篇文章中我们和面试官聊完了响应式、BFC容器、CSS中的单位，本篇文章将继续这些天面试完的CSS内容总结... 
    </details> 

- 🕯 [学算法要读《算法导论》吗？](https://juejin.cn/post/7339042929883381795) | Sun Feb 25 2024 11:22 AM 
    <details><summary>展开描述 ...</summary> 
...
- 💪 [让你微信、公众号具备ChatGPT功能（小白篇）](https://juejin.cn/post/7338797433898500147) | Sun Feb 25 2024 11:02 AM 
    <details><summary>展开描述 ...</summary> 
