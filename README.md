...
<!-- ruanyf:START -->
- 🌊 [科技爱好者周刊（第 257 期）：黄仁勋的 Nvidia 故事](http://www.ruanyifeng.com/blog/2023/06/weekly-issue-257.html) | Thu Jun 01 2023 11:58 PM
- 💪 [科技爱好者周刊（第 256 期）：最酷的乐高作品](http://www.ruanyifeng.com/blog/2023/05/weekly-issue-256.html) | Fri May 26 2023 12:13 AM
- 🐎 [科技爱好者周刊（第 255 期）：对待 AI 的正确态度](http://www.ruanyifeng.com/blog/2023/05/weekly-issue-255.html) | Fri May 19 2023 12:12 AM
- 🤔 [科技爱好者周刊（第 254 期）：人生是一个长板问题](http://www.ruanyifeng.com/blog/2023/05/weekly-issue-254.html) | Fri May 12 2023 12:07 AM
- 🧠 [科技爱好者周刊（第 253 期）：训练材料用完之日](http://www.ruanyifeng.com/blog/2023/05/weekly-issue-253.html) | Fri May 05 2023 12:11 AM<!-- ruanyf:END -->
...
<!-- juejin:START -->
- 🤗 [ref和reactive你必须要知道的使用场景和差异](https://juejin.cn/post/7192994086255591480) | Thu Jan 26 2023 4:11 PM 
    <details><summary>展开描述 ...</summary> 
    在 vue3 中的组合式 api 中，针对响应式有了一些改变，其中响应式 api 中，两个比较重要的是 ref 和 reactive，但是对于这两个区别以及使用场景，大多数同学都比较迷惑，这个文章将给 
    </details> 

- 🎡 [【深入学习JavaScript系列】26、触摸事件和其他常见事件](https://juejin.cn/post/7192992662868197434) | Thu Jan 26 2023 4:06 PM 
    <details><summary>展开描述 ...</summary> 
    触摸事件和其他常见事件 1.触摸操作概述 浏览器的触摸 API 由三个部分组成。 Touch：一个触摸点 TouchList：多个触摸点的集合 TouchEvent：触摸引发的事件实例 Touch接口 
    </details> 

- 🕯 [【深入学习JavaScript系列】25、进度事件和表单事件](https://juejin.cn/post/7192992417878900795) | Thu Jan 26 2023 4:06 PM 
    <details><summary>展开描述 ...</summary> 
    进度事件和表单事件 1.文档的加载 浏览器在加载一个页面时，是按照自上向下的顺序加载的，加载一行执行一行。 如果将js代码编写到页面的上边，当代码执行时，页面中的DOM对象还没有加载， 此时将会无法正 
    </details> 

- 🚀 [费解，遇到的一个 JDK 序列化 Bug !](https://juejin.cn/post/7192981173151203387) | Thu Jan 26 2023 3:22 PM 
    <details><summary>展开描述 ...</summary> 
    最近查看应用的崩溃记录的时候遇到了一个跟 Java 序列化相关的崩溃， 从崩溃的堆栈来看，整个调用堆栈里没有我们自己的代码信息。崩溃的起点是 Android 系统自动存储 Fragment 
    </details> 
...
<!-- iui:START -->
- 🌊 [2023 年 1月 每日分享](https://iui.su/164/) | Thu Jan 26 2023 6:35 AM 
    <details><summary>展开描述 ...</summary> 
    可以收藏「不死鸟发布页」dalao.ru ，速记：大佬点入 关于不死鸟每日分享栏目发现一些不错的资源，你有好的发现点击这里快速投稿，如需图文或其它建议可在这里回复反馈。1月26日免费匿名国外号码... 
    </details> 
