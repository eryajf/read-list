...
<!-- v2ex:START -->
- 🥸 [因为陪老婆的时候的时间太少跟老婆爆发了矛盾](https://www.v2ex.com/t/864539#reply3) | Wed Jul 06 2022 2:02 PM
- 🤗 [Java Sharding-JDBC 数据库分库分表问题](https://www.v2ex.com/t/864537#reply0) | Wed Jul 06 2022 1:49 PM
- 🎭 [经济好像真的不景气，转岗的，拿 N+1 的，缩编！](https://www.v2ex.com/t/864528#reply2) | Wed Jul 06 2022 1:14 PM
- 🥷 [[Android10 定制] 系统级 app 无法正确执行二进制文件](https://www.v2ex.com/t/864524#reply1) | Wed Jul 06 2022 1:02 PM
- 🐵 [经常看代码中出现 drain 这个词，比如 buffer_drain，不知道这个是啥意思](https://www.v2ex.com/t/864521#reply6) | Wed Jul 06 2022 12:51 PM<!-- v2ex:END -->

### 掘金-全站热点

<!-- juejin:START -->
- 🤗 [OA 审批任务中心性能优化 —— 复杂业务系统重构实践](https://juejin.cn/post/7117213168559980552) | Wed Jul 06 2022 11:03 AM 
    <details><summary>展开描述 ...</summary> 
    OA审批业务复杂性、数据规模大等问题，导致审批工作效率低，本文通过对OA业务梳理，针对数据模型难维护、查询复杂问题，建立基于业务需求索引表和查询后归并逻辑，提供一种对复杂业务系统特定接口性能优化方法。 
    </details> 

- 🎡 [OA 审批任务中心性能优化 —— 复杂业务系统重构实践](https://juejin.cn/post/7117213027446816782) | Wed Jul 06 2022 11:02 AM 
    <details><summary>展开描述 ...</summary> 
    OA审批业务复杂性、数据规模大等问题，导致审批工作效率低，本文通过对OA业务梳理，针对数据模型难维护、查询复杂问题，建立基于业务需求索引表和查询后归并逻辑，提供一种对复杂业务系统特定接口性能优化方法。 
    </details> 

- 🕯 [阿里云易立：云原生如何破解企业降本提效难题？](https://juejin.cn/post/7117206249543827487) | Wed Jul 06 2022 10:36 AM 
    <details><summary>展开描述 ...</summary> 
    为了解决云架构和云原生技术带来的新挑战，企业开始关注新的成本治理方法。通过IT、财务、业务等团队协同，在保障业务发展的同时帮助企业获得更好财务控制和可预测性。 
    </details> 

- 🚀 [Android OpenGL 开发—— 相机预览详解 （附Demo）](https://juejin.cn/post/7117202297569935397) | Wed Jul 06 2022 10:21 AM 
    <details><summary>展开描述 ...</summary> 
    Android 开发者的福利，一起整OpenGL ，学习音视频开发，一起升职加薪，走上人生巅峰，开整。 
    </details> 

- 💪 [OC对象底层内存开辟和实现&lpar;下&rpar;](https://juejin.cn/post/7117199327029624863) | Wed Jul 06 2022 10:08 AM 
    <details><summary>展开描述 ...</summary> 
    上一节中我们探索一下Objc和LLVM源码底层关于alloc的实现过程，并了解了如何来标识记录类的各种状态，总结并解释了提出的相关问题，这节我们继续看下alloc后续关于内存开辟、内存对齐以及类绑定的 
    </details> 
<!-- juejin:END -->
### 少数派
