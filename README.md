...
<!-- juejin:START -->
- 🤗 [表达式引擎在转转平台的实践](https://juejin.cn/post/7126721004356780045) | Mon Aug 01 2022 1:57 AM 
    <details><summary>展开描述 ...</summary> 
    采取表达式引擎的面向配置编程的方式，从灵活度、可读性、扩展性、投入成本相对于传统的编码方式效率提升明显，效果理想。 
    </details> 

- 🎡 [Vue3 父组件调用子组件方法（$refs 在setup&lpar;&rpar;、&lt;script setup&gt; 中使用）](https://juejin.cn/post/7126720661594210335) | Mon Aug 01 2022 1:56 AM 
    <details><summary>展开描述 ...</summary> 
    在 vue2 中 ref 被用来获取对应的子元素，然后调用子元素内部的方法。 在 Vue3 setup &lpar;&rpar; {} 中使用 ref，如何获取到子元素，并调用方法： 在 Vue3 &lt;script set 
    </details> 

- 🕯 [python pip安装第三方包速度慢，这篇博客给你安排清楚了](https://juejin.cn/post/7126720569289998367) | Mon Aug 01 2022 1:55 AM 
    <details><summary>展开描述 ...</summary> 
    携手创作，共同成长！这是我参与「掘金日新计划 · 8 月更文挑战」的第6天，点击查看活动详情 ⛳️ 实战场景 如果你是一名 Python 初学者，那一定会碰到使用第三方模块的场景，一般情况下，我们直接 
    </details> 

- 🚀 [Vue3 源码解读之模板AST 解析器&lpar;二&rpar;](https://juejin.cn/post/7126719209224175623) | Mon Aug 01 2022 1:50 AM 
    <details><summary>展开描述 ...</summary> 
    解析器在解析模板过程中，无论是解析文本节点、插值节点还是标签的属性值，最终都会调用 decodeHtml 函数来解码文本内容中可能存在的HTML实体。 
    </details> 

- 💪 [python笔记 生成器](https://juejin.cn/post/7126718930227298317) | Mon Aug 01 2022 1:49 AM 
    <details><summary>展开描述 ...</summary> 
    携手创作，共同成长！这是我参与「掘金日新计划 · 8 月更文挑战」的第6天，点击查看活动详情 0 环境 编辑器：idea或vscode 系统版本：windows10 python版本：3.9.6 1  
    </details> 
<!-- juejin:END -->
### 少数派
