...
<!-- v2ex:START -->
- 🥸 [阿里云主机编译安卓源码有推荐吗？](https://www.v2ex.com/t/893550#reply3) | Tue Nov 08 2022 4:29 AM
- 🤗 [Xmake v2.7.3 发布，包组件和 C++ 模块增量构建支持](https://www.v2ex.com/t/893545#reply2) | Tue Nov 08 2022 4:10 AM
- 🎭 [经过签名后的 apk 文件，无法升级](https://www.v2ex.com/t/893541#reply2) | Tue Nov 08 2022 3:55 AM
- 🥷 [close 异常](https://www.v2ex.com/t/893529#reply2) | Tue Nov 08 2022 3:22 AM
- 🐵 [i3wm 最近的几次更新引入了两个 bug](https://www.v2ex.com/t/893517#reply2) | Tue Nov 08 2022 2:54 AM<!-- v2ex:END -->

### 掘金-全站热点

<!-- juejin:START -->
- 🤗 [Go 十年了，终于想起要统一 log 库了！](https://juejin.cn/post/7163496615901626375) | Tue Nov 08 2022 4:28 AM 
    <details><summary>展开描述 ...</summary> 
    大家好，我是煎鱼。 在日常工作中，打日志是很常见的动作。毕竟不打日志，从内部来讲，一旦出问题，定位、排查都会变的非常困难。谁也不想大半夜在那靠猜解决问题。 在其他方面，对日志的存储的内容、时长、安全均 
    </details> 

- 🎡 [Xmake v2.7.3 发布，包组件和 C++ 模块增量构建支持](https://juejin.cn/post/7163488181839462436) | Tue Nov 08 2022 3:52 AM 
    <details><summary>展开描述 ...</summary> 
    Xmake 是一个基于 Lua 的轻量级跨平台构建工具。 它非常的轻量，没有任何依赖，因为它内置了 Lua 运行时。 
    </details> 

- 🕯 [1684. 统计一致字符串的数目 : 简简单单模拟题儿](https://juejin.cn/post/7163487974577930253) | Tue Nov 08 2022 3:52 AM 
    <details><summary>展开描述 ...</summary> 
    题目描述 这是 LeetCode 上的 1684. 统计一致字符串的数目 ，难度为 简单。 Tag : 「模拟」、「位运算」 给你一个由不同字符组成的字符串 allowed 和一个字符串数组 word 
    </details> 

- 🚀 [文件上传，还存储在应用服务器?](https://juejin.cn/post/7163485797138563086) | Tue Nov 08 2022 3:44 AM 
    <details><summary>展开描述 ...</summary> 
    本文正在参加「金石计划 . 瓜分6万现金大奖」 前言 嗨，大家好，我是希留，一个被迫致力于全栈开发的老菜鸟。 一般项目开发中都会有文件、图片、视频等文件上传并能够访问的场景。要实现这样的场景，要么把文 
    </details> 

- 💪 [微前端的前世今生](https://juejin.cn/post/7163481140165246983) | Tue Nov 08 2022 3:25 AM 
    <details><summary>展开描述 ...</summary> 
