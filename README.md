...
- 🐵 [使用 utools 打开 vscode 出现 gcc : 无法将“gcc”项识别为 cmdlet、函数、脚本文件或可运行程序的名称。请检查名称的拼写，如果包括路径，请确保路径正确，然后再试一次。](https://www.v2ex.com/t/898145#reply3) | Sat Nov 26 2022 11:53 AM<!-- v2ex:END -->
