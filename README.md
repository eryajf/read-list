...
<!-- juejin:START -->
- 🤗 [自制简陋微前端框架，支持 Vite，支持各种前端框架](https://juejin.cn/post/7155304825104629796) | Mon Oct 17 2022 2:37 AM 
    <details><summary>展开描述 ...</summary> 
    最近我有这样的需求： 在一个项目里同时使用 Vue 和 React 全程使用 Vite 3 开发和打包 全程使用 TypeScript 开发 首先我尝试了一些微前端框架，但是遇到一些问题。索性就自己尝 
    </details> 

- 🎡 [【代码大全】精华总结之数据名称&lpar;10&rpar;](https://juejin.cn/post/7155303007280693262) | Mon Oct 17 2022 2:30 AM 
    <details><summary>展开描述 ...</summary> 
    无需理由继续读 选择名称 命名时要考虑的最重要问题 简单明确 最好就是 英文拼写 面向问题 说明是什么 而不是要干什么 多用相关的名词 最佳名称长度 4-20 变量名的作用域 常用在 函数内的 单层遍 
    </details> 

- 🕯 [我们为什么需要 8K 视频？](https://juejin.cn/post/7155302955762057246) | Mon Oct 17 2022 2:30 AM 
    <details><summary>展开描述 ...</summary> 
    分辨率，一直是视频的硬指标，720p、1080p、到日渐普及的 4K，带给我们最直观的体验，就是越来越清晰了。然而在 4K 的屏幕上「数毛」还没几天，更加清晰的标准便来了——8K 
    </details> 

- 🚀 [【代码大全】精华总结之生成数据&lpar;9&rpar;](https://juejin.cn/post/7155302794772086814) | Mon Oct 17 2022 2:29 AM 
    <details><summary>展开描述 ...</summary> 
    为什么会继续读 因为读起来比较爽 而且 有很多内容可以借鉴 可以思考和实践 数据识别 数据结构识别测验题 自建数据类型的准则 如何避免初始化错误的一些准则 简单来说 变量需要初始化 如果重复使用 需要 
    </details> 

- 💪 [现代 CSS 指南 -- at-rule 规则扫盲](https://juejin.cn/post/7155300505776816158) | Mon Oct 17 2022 2:20 AM 
    <details><summary>展开描述 ...</summary> 
