...
- 🎡 [抖音直播违禁词有哪些？这6类直播违禁敏感词，一定不要用](https://juejin.cn/post/7157490857112207374) | Sun Oct 23 2022 12:01 AM 
    <details><summary>展开描述 ...</summary> 
    为了避免因为说错话导致直播违规被中断或是封禁，我整理了一些抖音直播违禁词，不清楚哪些是敏感词的朋友，一起来看看。 1、极限词不能用 抖音直播违禁词比较常见的就是极限词，包括但不限于： 国家级、世界级、 
    </details> 

- 🕯 [小红书引导用户关注，进行私域变现的办法](https://juejin.cn/post/7157488096932528135) | Sat Oct 22 2022 11:55 PM 
    <details><summary>展开描述 ...</summary> 
    玩小红书的朋友，都是引流到私域进行变现，所以最后一个玩法跟大家说说引流私域的几种方法： 1、大号直接引导私聊 比如在笔记或视频发布之后，你可以在评论区加一句：想要获取更多***信息，可以私信我哦~ 2 
    </details> 

- 🚀 [JVM内存模型](https://juejin.cn/post/7157481376558612516) | Sat Oct 22 2022 11:33 PM 
    <details><summary>展开描述 ...</summary> 
    持续创作，加速成长！这是我参与「掘金日新计划 · 10 月更文挑战」的第24天，点击查看活动详情 前情提要 上面对运行时数据区描述了很多，其实重点存储数据的是堆和方法区&lpar;非堆&rpar;，所以内存的设计也着重从 
    </details> 

- 💪 [JS 如何实现“上次操作未完成之前，禁止新的操作”的逻辑](https://juejin.cn/post/7157456455732297741) | Sat Oct 22 2022 10:36 PM 
    <details><summary>展开描述 ...</summary> 
    相信很多人都遇到过类似的场景： 某一个按钮是用来发送请求的，并且需要一段时间来处理。但是用户往往会在... 
    </details> 
<!-- juejin:END -->
### 少数派
