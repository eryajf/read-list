...
<!-- juejin:START -->
- 🤗 [Swift - LeetCode - 验证回文串](https://juejin.cn/post/7127154779230306311) | Tue Aug 02 2022 6:00 AM 
    <details><summary>展开描述 ...</summary> 
    题目 给定一个字符串，验证它是否是回文串，只考虑字母和数字字符，可以忽略字母的大小写。 说明： 本题中，我们将空字符串定义为有效的回文串。 示例1： 示例2： 方法一：筛选 + 判断 思路及解法 最简 
    </details> 

- 🎡 [记一次内部分享——瞎扯淡](https://juejin.cn/post/7127149603723411470) | Tue Aug 02 2022 5:42 AM 
    <details><summary>展开描述 ...</summary> 
    image.png 大家好，我是乔克。 今天给大家分享的主题是《闲聊Docker》，大家的工作都比较忙，但是也要劳逸结合，所以“闲”是忙里偷闲，而“聊”是只动嘴不动手，整个分享过程中不会去动手实践，也 
    </details> 

- 🕯 [设置 Git SSH 密钥](https://juejin.cn/post/7127148594917801997) | Tue Aug 02 2022 5:38 AM 
    <details><summary>展开描述 ...</summary> 
    使用命令行使用 Git 时，最常见的处理身份验证的方法是使用 SSH 密钥。 大多数基于 GUI 的客户端（如 GitHub Desktop）都可以为您处理这个问题，但有时您需要命令行，因此设置 SS 
    </details> 

- 🚀 [优化实战 第42期 - 前端如何高效的生成唯一ID](https://juejin.cn/post/7127145828611227678) | Tue Aug 02 2022 5:26 AM 
    <details><summary>展开描述 ...</summary> 
    技术背景 前端在做一些业务逻辑的时候，通常会使用一个唯一标识作为数据的 key 值，而有时候数据本身并没有这个唯一标识，使用下标的话又会引发一些隐藏的 Bug 甚至说在给后端传递集合数据的时候，会要求 
    </details> 

- 💪 [positon:sticky全面解析](https://juejin.cn/post/7127145202006884366) | Tue Aug 02 2022 5:24 AM 
    <details><summary>展开描述 ...</summary> 
    携手创作，共同成长！这是我参与「掘金日新计划 · 8 月更文挑战」的第2天，点击查看活动详情 sticky比喻材料的意思是粘性的，比喻人可以叫粘人的。 粘肯定有一个对象，在前端css样式规则里，sti 
    </details> 
<!-- juejin:END -->
### 少数派
