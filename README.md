...
- 🧠 [科技爱好者周刊（第 287 期）：禄丰恐龙谷记行](http://www.ruanyifeng.com/blog/2024/01/weekly-issue-287.html) | Fri Jan 19 2024 12:20 AM<!-- ruanyf:END -->
...
<!-- v2ex:START -->
- 🥸 [提高 5 倍以上的开发项目效率的神器，支持数据库 mysql、mongodb、postgresql、tidb、sqlite，使用 go 也可以低代码开发](https://www.v2ex.com/t/1020122#reply0) | Sat Mar 02 2024 2:55 PM
- 🤗 [[图标设计]想请教下各位这种图可以用什么工具实现](https://www.v2ex.com/t/1020120#reply0) | Sat Mar 02 2024 2:47 PM
- 🎭 [Python 潮流周刊第 40 期（摘要）](https://www.v2ex.com/t/1020117#reply1) | Sat Mar 02 2024 2:18 PM
- 🥷 [为什么我 Twitter 从没关注过一个技术博主，没点开过一条技术 tweet， AdGuard 全天打开， Who to follow 里面还是全是技术相关的东西？是哪里泄露了我的兴趣？](https://www.v2ex.com/t/1020107#reply9) | Sat Mar 02 2024 1:11 PM
- 🐵 [各位大佬，如何实现一个 avi 格式的视频播放平台，并且视频帧有关联信息的。](https://www.v2ex.com/t/1020106#reply6) | Sat Mar 02 2024 1:07 PM<!-- v2ex:END -->

### 掘金-全站热点

<!-- juejin:START -->
- 🤗 [解读数据架构——是否应该采用数据网格？神话、关注点和未来](https://juejin.cn/post/7341416970938695717) | Sat Mar 02 2024 3:08 PM 
    <details><summary>展开描述 ...</summary> 
    我要直言不讳——关于数据网格挑战的这一章是本书最长的章节之一。这并不是因为我认为数据网格是一个坏主意，或者我所讨论的其他架构更好；而是因为有很多关于数据网格的神话、关注点和挑战需要您了解。如果您决定构 
    </details> 

- 🎡 [面试官叫我聊聊异步,稳啦！全都稳啦！](https://juejin.cn/post/7341401110631596084) | Sat Mar 02 2024 3:07 PM 
    <details><summary>展开描述 ...</summary> 
    浅聊一下 当面试官叫我聊聊异步的时候，我就知道稳啦！全都稳啦！面试的时间一般在1-2个小时，所以当面试官问到你所擅长的领域时，你可以把你所知道的全部一一列举出来...拖延一下时间，让他别问你这么多问题 
    </details> 

- 🕯 [Spring Cloud Gateway-系统保护Sentinel集成](https://juejin.cn/post/7341323705022398505) | Sat Mar 02 2024 2:51 PM 
    <details><summary>展开描述 ...</summary> 
    Sentinel介绍 ​ 随着微服务的流行，服务和服务之间的稳定性变得越来越重要。Sentinel 是面向分布式、多语言异构化服务架构的流量治理组件 
    </details> 

- 🚀 [揭秘Java性能调优的层次 | 综合多方向提升应用程序性能与系统高可用的关键（架构层次规划）](https://juejin.cn/post/7341416970938646565) | Sat Mar 02 2024 2:51 PM 
    <details><summary>展开描述 ...</summary> 
    前言介绍 在信息技术飞速发展的时代，Java作为一种成熟、稳定且广泛应用的编程语言，已成为构建企业级应用的首选。然而，随着业务需求的日益复杂和数据处理量的不断增大，Java应用程序和系统性能调优变得愈 
    </details> 

- 💪 [一篇文章带你了解如何在Vue3自定义指令](https://juejin.cn/post/7341340317659267081) | Sat Mar 02 2024 2:48 PM 
    <details><summary>展开描述 ...</summary> 
...
<!-- iui:START -->
- 🌊 [2024 年 3 月 每日分享](https://iui.su/183/) | Sat Mar 02 2024 4:32 AM 
    <details><summary>展开描述 ...</summary> 
    可以收藏「不死鸟发布页」dalao.ru ，速记：大佬点入 关于不死鸟每日分享栏目发现一些不错的资源，你有好的发现点击这里快速投稿，如需图文或其它建议可在这里回复反馈。3月2日Just Mark... 
    </details> 
...
- 🌜 [2024 年 2 月 每日分享](https://iui.su/182/) | Thu Feb 29 2024 5:30 AM 
    <details><summary>展开描述 ...</summary> 
    可以收藏「不死鸟发布页」dalao.ru ，速记：大佬点入 关于不死鸟每日分享栏目发现一些不错的资源，你有好的发现点击这里快速投稿，如需图文或其它建议可在这里回复反馈。2月29日bunny免费1... 
    </details> 

- 🏊 [免费的离线下载神器](https://iui.su/2014/) | Wed Feb 28 2024 3:53 AM 
    <details><summary>展开描述 ...</summary> 
    安卓下载器下载速度比较快的安卓下载器，由多位不死鸟网友分享。 @张自来 @唯唯 2月28日新增一个黑科云下载，可以离线解析播放，不支持下载。2月19日新增一个速度下载APP，支持56种类型资源的... 
    </details> 
