...
<!-- juejin:START -->
- 🤗 [JS获取对象属性API汇总（可/不可枚举、symbol）（建议收藏）](https://juejin.cn/post/7156789420396544008) | Fri Oct 21 2022 2:38 AM 
    <details><summary>展开描述 ...</summary> 
    对象的每个属性都有一个描述对象（Descriptor），用来控制该属性的行为。方法可以获取该属性的描述对象。描述对象的enumerable属性，称为“可枚举性”，如果该属性为false，就表示某些操作 
    </details> 

- 🎡 [基于K8S，云原生架构的成本优化指南](https://juejin.cn/post/7156784765637492767) | Fri Oct 21 2022 2:21 AM 
    <details><summary>展开描述 ...</summary> 
    在货拉拉主导了Kubernetes从0到1落地全过程，致力于探索符合货拉拉特点的云原生之道。  今天的分享主要包含以下五个方面的内容： 一、货拉拉的基本情况介绍 二、基于K8S的成本优化手段 三、符合 
    </details> 

- 🕯 [视频目标跟踪从0到1，概念与方法](https://juejin.cn/post/7156774091519688740) | Fri Oct 21 2022 1:39 AM 
    <details><summary>展开描述 ...</summary> 
    在今天的文章中，我们将深入研究视频目标跟踪。我们从基础开始，了解目标跟踪的需求，然后了解视觉目标跟踪的挑战和算法模型，最后，我们将介绍最流行的基于深度学习的目标跟踪方法。 
    </details> 

- 🚀 [ODTK：来自NVIDIA的旋转框物体检测工具箱](https://juejin.cn/post/7156773639805730853) | Fri Oct 21 2022 1:37 AM 
    <details><summary>展开描述 ...</summary> 
    旋转框相比矩形框可以更好的拟合物体，同时标注起来比分割要方便的多，使用来自NVIDIA的ODTK可以方便的训练，实施和部署旋转框物体检测模型，同时具备多种扩展功能。 
    </details> 

- 💪 [花了两天时间，解决了一个“崩溃”的问题](https://juejin.cn/post/7156773137789485064) | Fri Oct 21 2022 1:35 AM 
    <details><summary>展开描述 ...</summary> 
    主要是记录解决项目中的一个浏览器崩溃，页面强制刷新问题的思路和方法，涉及的操作有modal弹框，pdf预览，签字，canvas截取视频流等 
    </details> 
<!-- juejin:END -->
### 少数派
