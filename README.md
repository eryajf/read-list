...
<!-- juejin:START -->
- 🤗 [多行文本下的文字渐隐消失术](https://juejin.cn/post/7132299418631405581) | Tue Aug 16 2022 2:44 AM 
    <details><summary>展开描述 ...</summary> 
    本文将探讨一下，在多行文本情形下的一些有意思的文字动效。 多行文本，相对于单行文本，场景会复杂一些，但是在实际业务中，多行文本也是非常之多的，但是其效果处理比起单行文本会更困难。 单行与多行文本的渐隐 
    </details> 

- 🎡 [火山引擎开发者服务加盟GOPS 2022 · 深圳站](https://juejin.cn/post/7132297044730839076) | Tue Aug 16 2022 2:36 AM 
    <details><summary>展开描述 ...</summary> 
    8月20日上午，火山引擎开发者服务的两位专家将于第十八届 GOPS 全球运维大会字节跳动专场（大宴会厅B）进行分享，敬请期待！ 
    </details> 

- 🕯 [分布式系统的特征、瓶颈以及性能指标介绍](https://juejin.cn/post/7132297120648232973) | Tue Aug 16 2022 2:35 AM 
    <details><summary>展开描述 ...</summary> 
    本文将作为专栏的第0篇，将从三个方面来讲述一下我理解的&quot;分布式系统&quot; - 分布式系统的特点 - 分布式系统面临的挑战 - 如何衡量一个分布式系统 
    </details> 

- 🚀 [图解机器学习之回归模型性能评估指标](https://juejin.cn/post/7132292197004607525) | Tue Aug 16 2022 2:16 AM 
    <details><summary>展开描述 ...</summary> 
    一个房价预测的任务，老板说你看看这个模型咋样？ 我们先绘制一个坐标轴： Y 轴为房价，X 轴为年份。将过去房价数据绘制为绿色，回归模型绘制为蓝色。 关键问题是，怎么知道这个模型的好坏呢？ 
    </details> 

- 💪 [ICCV2021|你以为这是一个填色模型？其实我是检索模型！](https://juejin.cn/post/7132289118523883556) | Tue Aug 16 2022 2:04 AM 
    <details><summary>展开描述 ...</summary> 
    【写在前面】 语言引导的人称搜索的关键是在视觉输入和文本输入之间建立跨模态关联。现有方法侧重于设计多 
    </details> 
<!-- juejin:END -->
### 少数派
