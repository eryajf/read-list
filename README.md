...
<!-- juejin:START -->
- 🤗 [Vue 2 阅读理解（十三）之 initState 状态初始化](https://juejin.cn/post/7135375056800219150) | Wed Aug 24 2022 9:39 AM 
    <details><summary>展开描述 ...</summary> 
    携手创作，共同成长！这是我参与「掘金日新计划 · 8 月更文挑战」的第26天，点击查看活动详情 initState 状态初始化 在配置标准化合并以及声明周期初始化完成之后，会调用 callHook&lpar;&#39; 
    </details> 

- 🎡 [Vue 3-150行代码 实现新国标红绿灯效果实操案例](https://juejin.cn/post/7135371725427965959) | Wed Aug 24 2022 9:28 AM 
    <details><summary>展开描述 ...</summary> 
    昨天刷视频，都是关于新国标红绿灯的，看大家议论纷纷，下班就用150行代码通过Vue组件实践红绿模拟演示，视频也跟大家展示过了。今天接着更新图文版本，大家跟着优雅哥通过该案例实操模拟一下。 不过新国标红 
    </details> 

- 🕯 [小册上新 | 前端工程师的 Node.js 必修课](https://juejin.cn/post/7135370702407860261) | Wed Aug 24 2022 9:22 AM 
    <details><summary>展开描述 ...</summary> 
    现在的 Web 前端已经离不开 Node.js，我们广泛使用的 Babel、Webpack、工程化都是基于 Node 的。各个互联网大厂的 Web 应用项目和中后台技术栈中，也都少不了 Node.js 
    </details> 

- 🚀 [如何优雅地为列表非首项元素添加样式，关键靠他们。](https://juejin.cn/post/7135370609281728520) | Wed Aug 24 2022 9:22 AM 
    <details><summary>展开描述 ...</summary> 
    在开发中我们常常会会遇到列表相关的场景，比如说：卡片列表，导航栏等等。而在实现上，有一个问题需要我们去注意：如何给列表非首项元素添加样式，简单地来说就是一个列表中除第一个元素外其他元素赋予样式， 
    </details> 

- 💪 [性能优化（一）卡顿优化](https://juejin.cn/post/7135368386841673764) | Wed Aug 24 2022 9:13 AM 
    <details><summary>展开描述 ...</summary> 
