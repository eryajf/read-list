...
<!-- juejin:START -->
- 🤗 [认识区块链（四）：区块链的底层实现之密码学](https://juejin.cn/post/7345683670050766902) | Wed Mar 13 2024 10:01 AM 
    <details><summary>展开描述 ...</summary> 
    密码学概述 区块链起源于密码学，可以说区块链的核心，以及安全性、不可篡改性的来源很大一部分都是基于密码学实现的。 密码学相信对大家来说都有接触过，但是不搞安全的同学可能没有深入学习过，密码学是网络安全 
    </details> 

- 🎡 [🚫为了防止狗上沙发，写了一个浏览器实时识别目标功能📷](https://juejin.cn/post/7345672631323394098) | Wed Mar 13 2024 9:53 AM 
    <details><summary>展开描述 ...</summary> 
    背景 家里有一条狗🐶，很喜欢乘人不备睡沙发🛋️，恰好最近刚搬家 + 狗迎来了掉毛期 不想让沙发上很多毛。所以希望能识别到狗，然后播放“gun 下去”的音频📣。 需求分析 需要一个摄像头📷 利用 chr 
    </details> 

- 🕯 [JS递归过滤树形结构数组对象-模糊查询](https://juejin.cn/post/7345684394583556133) | Wed Mar 13 2024 9:45 AM 
    <details><summary>展开描述 ...</summary> 
    前言 今天实际项目有个需求，需要由前端来实现简单树形数据的模糊搜索功能，需求是这样的，简单描述下需求内容： 思来想去，最后用了递归 + includes模糊查询 的方式来实现的。特地记录一下 代码实现 
    </details> 

- 🚀 [面试官：自定义一个React hook，用于监听组件的重新渲染](https://juejin.cn/post/7345662552960598025) | Wed Mar 13 2024 9:38 AM 
    <details><summary>展开描述 ...</summary> 
    如题所示：自定义一个 hook，如果监听到组件重新渲染，则在当前页面进行响应。（首次加载组件不执行） 
    </details> 

- 💪 [细聊Vue中的nextTick（面试常考！！！附带手写nextTick代码）](https://juejin.cn/post/7345499817316188160) | Wed Mar 13 2024 9:35 AM 
    <details><summary>展开描述 ...</summary> 
    在编写复杂的应用程序时，我们经常需要处理异步 DOM 更新的情况，这可能导致一些意外行为或者需要特殊处理。这时候，Vue 提供了一个强大的工具来解决这个问题：nextTick 方法。 
    </details> 
<!-- juejin:END -->
### 少数派
