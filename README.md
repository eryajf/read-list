...
<!-- v2ex:START -->
- 🥸 [ssr 有哪些好的方案吗？](https://www.v2ex.com/t/886701#reply5) | Thu Oct 13 2022 9:58 AM
...
- 🐵 [WPF 使用 DrawingContext 绘制刻度条](https://www.v2ex.com/t/886665#reply0) | Thu Oct 13 2022 7:53 AM<!-- v2ex:END -->

### 掘金-全站热点

<!-- juejin:START -->
- 🤗 [擦玻璃效果-鼠标移动响应时间粒度问题](https://juejin.cn/post/7153882870098952205) | Thu Oct 13 2022 6:39 AM 
    <details><summary>展开描述 ...</summary> 
    我正在参加「掘金·启航计划」 问题描述： 在实现擦玻璃效果时，需要实现根据鼠标移动进行绘制路径。开始运用mousemove来实现绘制圆形时，发现鼠标移动速度过快时，绘制的圆形，不能连接一起，中间出现断 
    </details> 

- 🎡 [【Nodejs】安全的网络服务 | 实现一个HTTPS服务](https://juejin.cn/post/7153851008018284575) | Thu Oct 13 2022 4:38 AM 
    <details><summary>展开描述 ...</summary> 
    之前我们介绍的 HTTP 服务，数据在服务器端和客户端之间传递是基于明文传输的，一旦在网络被人监控，数据就可能遭到泄露。在网络安全日益严峻的今天，这样的漏洞是致命的。 
    </details> 

- 🕯 [【数据结构】带头+双向+循环链表（增、删、查、改）的实现_【附源码、图片示例】](https://juejin.cn/post/7153655519918440479) | Wed Oct 12 2022 3:57 PM 
    <details><summary>展开描述 ...</summary> 
    持续创作，加速成长！这是我参与「掘金日新计划 · 10 月更文挑战」的第8天，点击查看活动详情 前情提要 本章节是数据结构的带头+双向+循环链表的相关知识~ 接下来我们即将进入一个全新的空间，对代码有 
    </details> 

- 🚀 [C#调用执行命令行窗口cmd，及需要交互执行的处理](https://juejin.cn/post/7153649331092848653) | Wed Oct 12 2022 3:33 PM 
    <details><summary>展开描述 ...</summary> 
    C#执行外部程序用到的是Process进程类，打开一个进程，可以指定进程的启动信息StartInfo（启动的程序名、输入输出是否重定向、是否显示UI界面、一些必要参数等）... 
    </details> 

- 💪 [5 分钟带你实现一个可控制缓存销毁的 keepAlive 组件](https://juejin.cn/post/7153646475971395591) | Wed Oct 12 2022 3:22 PM 
    <details><summary>展开描述 ...</summary> 
    页面缓存是前端开发过程中常见的业务场景，最简单的方式是使用keepAlive，网上有很多教程涉及，但如何自主控制缓存的组件销毁这一块大多讲的不是很清晰，本文会带你实现一个可控制缓存销毁的Vue组件。 
    </details> 
<!-- juejin:END -->
### 少数派
