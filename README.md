...
- 🎡 [Java语言中的数据流](https://juejin.cn/post/7158471612331720735) | Tue Oct 25 2022 3:27 PM 
    <details><summary>展开描述 ...</summary> 
    数据流是一串连续不断的数据的有序集合。打个比方：它就像是流水，只要前面不断地有水供应，就会形成连续不断地水流。数据写入程序可以是逐段地向数据流管道中写入数据，这些数据段会根据进入管道的先后顺序形成一条 
    </details> 
