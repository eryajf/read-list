...
<!-- juejin:START -->
- 🤗 [快速理解 Vite 的依赖预构建](https://juejin.cn/post/7139430132762017800) | Sun Sep 04 2022 7:55 AM 
    <details><summary>展开描述 ...</summary> 
    当我们使用 Vite 进行开发时，会进行依赖预构建，即将第三方依赖进行打包，并在开发环境下使用这些打包过的第三方依赖。 那这个过程中，Vite 到底做了哪些事情呢？ 
    </details> 

- 🎡 [Canvas定制组件——事件线之折线图的绘制](https://juejin.cn/post/7139426940772483108) | Sun Sep 04 2022 7:44 AM 
    <details><summary>展开描述 ...</summary> 
    对于趋势折线的绘制，今天就主要介绍下面几个方面： - Y轴以及辅助线； - 绘制折线； - 图例的绘制； 
    </details> 

- 🕯 [Koltin协程：Flow的触发与消费](https://juejin.cn/post/7139427332602724365) | Sun Sep 04 2022 7:44 AM 
    <details><summary>展开描述 ...</summary> 
    本文分析示例代码如下： 一.Flow的触发与消费     在Kotlin协程：Flow基础原理的分析中，流的触发与消费都是同时进行的。每当调用collect方法时，会触发流的执行，并同时在collec 
    </details> 

- 🚀 [bash shell自定义函数](https://juejin.cn/post/7139426611304071199) | Sun Sep 04 2022 7:41 AM 
    <details><summary>展开描述 ...</summary> 
    我正在参与掘金创作者训练营第6期，  在编写shell脚本时候，经常会遇到多个地方使用了同一段代码的情况，bash shell提供了用户自定义函数功能来解决这个问题; 
    </details> 

- 💪 [详解 TS 中的交叉类型](https://juejin.cn/post/7139416689040424991) | Sun Sep 04 2022 7:04 AM 
    <details><summary>展开描述 ...</summary> 
