...
<!-- juejin:START -->
- 🤗 [重构改造Javascript项目为Typescript项目](https://juejin.cn/post/7161717444027875364) | Thu Nov 03 2022 9:22 AM 
    <details><summary>展开描述 ...</summary> 
    项目基础信息和改造目标 之前组内有一个基于vite脚手架生成的vue3项目，功能前前后后开发了一个月，基本的业务需求已经满足，但是这个项目是一个纯JavaScript的项目，不符合大前端趋势和方向，所 
    </details> 

- 🎡 [数据库漫谈之事务](https://juejin.cn/post/7161711381589262367) | Thu Nov 03 2022 8:58 AM 
    <details><summary>展开描述 ...</summary> 
    本文正在参加「技术专题19期 漫谈数据库技术」活动 什么是事务？ 当我们使用数据库的时候，我们设想下面场景 数据库存储过程中途因为故障崩溃亏了。 客户端和数据库之间的链接中断了。 并发访问数据库时，多 
    </details> 

- 🕯 [人类高质量代码—Golang标准库net/rpc](https://juejin.cn/entry/7161707855077179428) | Thu Nov 03 2022 8:44 AM 
    <details><summary>展开描述 ...</summary> 
    前言 RPC协议是我们在开发过程中最经常接触的技术之一，Go 标准库net/rpc提供了一个简单、强大且高性能的 RPC 实现，仅需编写很少的代码就能实现 RPC服务 
    </details> 

- 🚀 [canvas非正式笔记：能用的几个例子](https://juejin.cn/entry/7161701840508174350) | Thu Nov 03 2022 8:21 AM 
    <details><summary>展开描述 ...</summary> 
    canvas绘图比较常见，尤其是前端在一些简单图片处理中用到的比较频繁。其中有一些优秀的 js 库中也有使用，如：three.js 、qrcode、html2canvas、Chart.js。 
    </details> 

- 💪 [前端动画问题和总结](https://juejin.cn/entry/7161693001087975432) | Thu Nov 03 2022 7:46 AM 
    <details><summary>展开描述 ...</summary> 
    在M端开发带有动画的页面时，必须要考虑动画的兼容性和动画的流畅性，这里对遇到的动画问题做一些总结，同时这里得出一个结论。 
    </details> 
<!-- juejin:END -->
### 少数派
