...
<!-- juejin:START -->
- 🤗 [周日给自己的项目来点&#39;小礼物&#39;吧](https://juejin.cn/post/7133078192172040206) | Thu Aug 18 2022 5:06 AM 
    <details><summary>展开描述 ...</summary> 
    什么？黑心996公司要让你提桶跑路了？ 想在离开前给你们的项目留点小礼物？ 仅在周日时： 当数组长度可以被7整除时，Array.includes 永远返回false。 Array.map 有5%概率会 
    </details> 

- 🎡 [Rust Wasm 图片转 ASCII 艺术](https://juejin.cn/post/7133073003444699144) | Thu Aug 18 2022 4:46 AM 
    <details><summary>展开描述 ...</summary> 
    有一些隐藏在代码中的 ASCII 有意思的图片，如： 可以把一些有意思的图片转成 ASCII 艺术图，嵌到代码中，或者 log 中。 整体原理比较简单，这里用 Rust Wasm 实现一下。 1. 原 
    </details> 

- 🕯 [面向大规模数据的云端管理，百度沧海存储产品解析](https://juejin.cn/post/7133065744157736996) | Thu Aug 18 2022 4:18 AM 
    <details><summary>展开描述 ...</summary> 
    本文整理自同名《云智公开课》系列分享，详细介绍百度沧海·存储如何进行大规模数据，流转上云、智能分级存储、安全管理、多业务应用。 
    </details> 

- 🚀 [「趣学前端」元编程，翻书学习时发现的陌生词汇，当然是记个笔记](https://juejin.cn/post/7133063647533727781) | Thu Aug 18 2022 4:11 AM 
    <details><summary>展开描述 ...</summary> 
    携手创作，共同成长！这是我参与「掘金日新计划 · 8 月更文挑战」的第20天，点击查看活动详情。今天分享元编程的学习笔记，即收获了新知识，又来了新灵感，今天也是特别有收获的一天。 
    </details> 

- 💪 [06 - 线索化二叉树和哈夫曼树](https://juejin.cn/post/7133063436389089310) | Thu Aug 18 2022 4:09 AM 
    <details><summary>展开描述 ...</summary> 
    携手创作，共同成长！这是我参与「掘金日新计划 · 8 月更文挑战」的第22天，点击查看活动详情 线索化二叉树的认识 空链域的出现 对于具有n个节点的二叉树，采用链式存储结构时，每个节点有两个指针域，总 
    </details> 
<!-- juejin:END -->
### 少数派
