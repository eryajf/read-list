...
<!-- juejin:START -->
- 🤗 [运行第一个QT6 demo](https://juejin.cn/post/7341009240457936934) | Fri Mar 01 2024 6:08 AM 
    <details><summary>展开描述 ...</summary> 
    下载与安装QT Creator 下载QT Creator 下载QT Creator 访问QT官网，下载对应操作系统Qt，这里为Windows。 安装QT Creator 第一次安装 这里选择MinGW 
    </details> 

- 🎡 [sprintboot集成flink快速入门demo](https://juejin.cn/post/7340953208872009778) | Fri Mar 01 2024 5:53 AM 
    <details><summary>展开描述 ...</summary> 
    一、flink介绍 Flink是一个批处理和流处理结合的统一计算框架，其核心是一个提供了数据分发以及并行化计算的流数据处理引擎。它的最大亮点是流处理，是业界最顶级的开源流处理引擎。Flink最适合的应 
    </details> 

- 🕯 [一文搞定常见分布式事务实现](https://juejin.cn/post/7341007339215929356) | Fri Mar 01 2024 5:52 AM 
    <details><summary>展开描述 ...</summary> 
    前言 在一文带你理解什么是分布式事务 - 掘金中我们介绍了什么是分布式事务，这篇文章会深入介绍市面上常见的分布式事务实现方案，并探讨它们的优缺点，以及可能会产生的问题。 分布式事务的关键点 ● 创建事 
    </details> 

- 🚀 [程序员的财富指南 第五章 （打造持续增值的技能资产）](https://juejin.cn/post/7341007182563393574) | Fri Mar 01 2024 5:48 AM 
    <details><summary>展开描述 ...</summary> 
    在职业发展的路上，理解财富和金钱的本质不仅重要，而且对于我们作为程序员的长远规划至关重要。金钱和财富，虽常被通用，但意味着两个截然不同的概念。 金钱 金钱是交易和信用的媒介，是你为社会提供价值后获得的 
    </details> 

- 💪 [10个技巧，3分钟教会你高效寻找开源项目](https://juejin.cn/post/7341019035185954851) | Fri Mar 01 2024 5:41 AM 
    <details><summary>展开描述 ...</summary> 
    大家好，我是知微！ 作为程序员，不论是开发还是学习，肯定会用到开源项目，那么怎么快速在开源网站找到这些项目呢？ 常用的开源网站有：github 和 gitee github是全球最大的开源社区，今天就 
    </details> 
<!-- juejin:END -->
### 少数派
