...
<!-- juejin:START -->
- 🤗 [极大提升开发效率的Idea插件](https://juejin.cn/post/7143211363803299848) | Wed Sep 14 2022 12:30 PM 
    <details><summary>展开描述 ...</summary> 
    网上有很多人都分享过或者推荐过一些插件，虽然有很多人都写过类似的内容，个人还是试着看能不能从新的角度分享下一些Idea的插件。 怎么找到好的插件？那些插件能提升开发效率？ 
    </details> 

- 🎡 [前端如何实现json数据导出到doc](https://juejin.cn/post/7143210453035024392) | Wed Sep 14 2022 12:28 PM 
    <details><summary>展开描述 ...</summary> 
    组件选择 因为导出word需要保留一定的格式，所以这里选择docxtemplater，利用定制导出模板的方式限制数据的导出格式。 实现一个最简单的导出 安装（后续的demo依赖相同） 用法 单条数据导 
    </details> 

- 🕯 [K2 编译器是什么？世界第二高峰又是哪座？](https://juejin.cn/post/7143207967775522823) | Wed Sep 14 2022 12:16 PM 
    <details><summary>展开描述 ...</summary> 
    众所周知，Kotlin团队正在开发新版Kotlin编译器，并命名为K2。那么K2是什么意思呢？难道是Kotlin第二版编译器的意思？ 
    </details> 

- 🚀 [前端监控系列3 ｜ 如何衡量一个站点的性能好坏](https://juejin.cn/post/7143201009781702687) | Wed Sep 14 2022 11:50 AM 
    <details><summary>展开描述 ...</summary> 
    高性能站点比低性能站点更能吸引和留住用户，而留住用户对于提高用户转化率至关重要。本文以此为背景，介绍字节内部是如何衡量站点性能的，如何依靠性能监控定位线上站点性能问题。 
    </details> 

- 💪 [简单手写实现React类组件的state更新](https://juejin.cn/post/7143201165998555143) | Wed Sep 14 2022 11:49 AM 
    <details><summary>展开描述 ...</summary> 
