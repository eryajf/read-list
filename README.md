...
<!-- juejin:START -->
- 🤗 [怎么做到一图胜千言](https://juejin.cn/post/7153432342919397383) | Wed Oct 12 2022 1:31 AM 
    <details><summary>展开描述 ...</summary> 
    本文将介绍方案设计和程序设计过程中常遇到两种图的类型：【流程图】和【时序图】，便于大家在写设计文档时可以充分利用好这两种图形来更好的说明我们的方案。 
    </details> 

- 🎡 [【微服务专题】深入理解与实践微服务架构&lpar;十九&rpar;之Sentinel数据双向同步&lpar;1&rpar;](https://juejin.cn/post/7153431718781779976) | Wed Oct 12 2022 1:29 AM 
    <details><summary>展开描述 ...</summary> 
    持续创作，加速成长！这是我参与「掘金日新计划 · 10 月更文挑战」的第8天，点击查看活动详情 Sentinel数据双向同步 我们回顾一下，首先Sentinel规则的存储默认是存储在内存的，应用重启之 
    </details> 

- 🕯 [布隆过滤器是否好用，得看哈希函数写成啥样](https://juejin.cn/post/7153425190905446436) | Wed Oct 12 2022 1:04 AM 
    <details><summary>展开描述 ...</summary> 
    布隆过滤器是一个基于数组和哈希函数散列元素的结构，很像HashMap的哈希桶。布隆过滤器可以用于检测一个元素是否在集合中。它的优点是空间效率和查询时间比一般算法要好很多，但也有一定概率的误判性。 
    </details> 

- 🚀 [2022重庆前端交流会「同舟」：等你来报名！](https://juejin.cn/post/7153422537916383262) | Wed Oct 12 2022 12:55 AM 
    <details><summary>展开描述 ...</summary> 
    「同舟」共济扬帆起，乘风破浪万里航。 在大家的期待与呼声中，2022 重庆前端交流会来啦！！ 本次交流会聚焦时下火热的前沿技术和实践经验，特邀精选主题分享；并且重磅推出 Light Talk，倾听更丰 
    </details> 

- 💪 [【C/C++】623. 在二叉树中增加一行](https://juejin.cn/post/7153418590052417567) | Wed Oct 12 2022 12:38 AM 
    <details><summary>展开描述 ...</summary> 
    持续创作，加速成长！这是我参与「掘金日新计划 · 10 月更文挑战」的第15天，点击查看活动详情 本文包括题目描述、题目整理、题目的解题思路以及具体的实现和代码，逐步对题目进行详细解析，深入浅出总结 
    </details> 
<!-- juejin:END -->
### 少数派
