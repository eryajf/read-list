...
<!-- juejin:START -->
- 🤗 [10V单通道负载开关](https://juejin.cn/post/7338443551746031656) | Fri Feb 23 2024 1:19 PM 
    <details><summary>展开描述 ...</summary> 
    概述 EM5220是一款单通道负载开关，具有可编程上升时间和集成输出放电控制。该设备包含一个P沟道NOSFET，可以通过输入进行操作电压范围为4.5V至10V。开关由接通和断开低电平逻辑输入控制，其能 
    </details> 
